...
<div id="wrapper">
	 <div id="content-wrapper">
 		<div class="container-fluid">
            	 ...
            	 <img style="margin-left:250px;" src="{{ asset('images/wlg-corporation.png')}}"   alt="WLG Philippines Corporation">
            	 	 <p >
					...
					<div class="col-lg-12">
						 <div class="card-body">
                          ...
                          <table style="border:1px solid black;">
                          		  <thead>
	                                  <tr>
                                      <th  style="height: 1%; text-align: center;" >MODEL</th>
                                  ...
                                  <tbody>
                                  		<tr style="border:1px solid black;">
	                                  	 	<td style="text-align:center; border: 1px solid black;">{{ $purchaseOrder['model']}}</td>
