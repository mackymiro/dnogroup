...
<div id="wrapper">
	 <div id="content-wrapper">
 		<div class="container-fluid">
                 ...
                 <img style="margin-left: 230px;" src="{{ asset('images/dno-food-venture.png')}}"   alt="DNO Food Ventures">
                            ...
                            <table style="border:1px solid black;">
                                ...
                                ?>
									...
									<tr style="border:1px solid black;">
										...
										<td style="text-align:center; border: 1px solid black;">{{ $getTransactionListCash->module_code}}{{ $getTransactionListCash->dno_food_venture_code}}</td>
                            ...
                            <table style="border:1px solid black;">
                                ...
                                ?>
									...
									<tr style="border:1px solid black;">
										...
										<td style="text-align:center; border: 1px solid black;">{{ $getTransactionListCheck->module_code}}{{ $getTransactionListCheck->dno_food_venture_code}}</td>
