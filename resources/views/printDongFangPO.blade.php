...
<div id="wrapper">
	 <div id="content-wrapper">
 		<div class="container-fluid">
            	 ...
            	 <img style="margin-left:200px;" src="{{ asset('images/dong-fang-corporation.png')}}"   alt="Dong Fang Corporation">
	                              ...
	                              <table >
	                                   <thead>
                                            <tr>
                                                ...
                                                <th>{{ $purchaseOrder[0]->module_code }}{{ $purchaseOrder[0]->dong_fang_code}}</a></th>
                                            </tr>
                                            <tr>
                                                <th>Date:</th>
