    		  ...
    		  <div class="row">
    		  		<div class="col-lg-12">
    		  			<div class="card mb-3">
                            ...
                            <form action="{{ action('LoloPinoyGrillCommissaryController@updateSalesInvoice', $getSalesInvoice['id']) }}" method="post">
                        		{{csrf_field()}}
  				...
  				<div class="col-lg-12">
  					<div class="card mb-3">
                        ...
                        <div class="card-body">
                    		 ...
                    		 <div>
                              @if($user->role_type == 1)
                              <a href="{{ url('lolo-pinoy-grill-commissary/add-new-lolo-pinoy-grill-sales-invoice/'.$getSalesInvoice['id'] ) }}" class="btn btn-primary">Add New</a>
                              @endif
                            </div>
                        </div>
  					</div>
