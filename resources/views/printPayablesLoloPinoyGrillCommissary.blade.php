...
<div id="wrapper">
	 <div id="content-wrapper">
 		<div class="container-fluid">
				 ...
				 <img style="margin-left: 170px;" src="{{ asset('images/lolo-pinoy-grill.jpeg')}}"  width="366" height="178"  alt="Lolo Pinoy Grill">
					 	 <p >
	                          ...
	                          <div style="float:right; width: 50%">
	                              <table >
	                                   <thead>
											...
											<tr>
                                                <th>PV No</th>
                                                <th>{{ $payableId[0]->module_code}}{{ $payableId[0]->lolo_pinoy_grill_code}}</th>
                                            </tr>
											<tr>
