    ...
    <div id="content-wrapper">
 		<div class="container-fluid">
            ...
            <ol class="breadcrumb">
              ...
              <a href="{{ url('dno-resources-development/statement-of-account/lists') }}">Back to Lists</a>
            <div class="col-lg-12">
        			 ...
        			 <div class="card mb-3">
                            ...
                            View Statement Of Account 
                              <div class="float-right">
                               <a href="{{ action('DnoResourcesDevelopmentController@printSOA', $viewStatementAccount[0]->id) }}"><i class="fa fa-print fa-2x" aria-hidden="true"></i></a>
                             </div>
                        </div>
                        <div class="card-body">
