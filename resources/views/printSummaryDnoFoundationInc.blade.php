                            ...
                            <table style="border:1px solid black;">
                                ...
                                ?>
									...
									<tr style="border:1px solid black;">
										...
										<td style="text-align:center; border: 1px solid black;">{{ $getTransactionListCash->module_code}}{{ $getTransactionListCash->dno_foundation_code}}</td>
                            ...
                            <table style="border:1px solid black;">
                                ...
                                ?>
									...
									<tr style="border:1px solid black;">
										...
										<td style="text-align:center; border: 1px solid black;">{{ $getTransactionListCheck->module_code}}{{ $getTransactionListCheck->dno_foundation_code}}</td>
