											...
											?>
				  							...
				  							<tr id="deletedId{{ $getTransactionList->id }}">
												  ...
												  @if($getTransactionList->status != "FULLY PAID AND RELEASED")
												 	 <p style="width:250px;">	
			  										<a href="{{ url('dno-food-ventures/edit-payables-detail/'.$getTransactionList->id) }}" title="Edit">{{ $getTransactionList->invoice_number}}</a>
												  	</p>
												  @else
												...
												<td class="bg-danger" style="color:white;">												  
			  									...
			  									<td class="bg-success" style="color:white; "><p style="width:240px;"><a class="anchor" href="{{ url('dno-food-ventures/view-payables-details/'.$getTransactionList->id) }}">{{ $getTransactionList->status }}</a></p></td>
