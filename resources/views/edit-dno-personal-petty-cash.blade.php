            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <form action="{{ action('DnoPersonalController@updatePettyCash', $pettyCash[0]->id)}}" method="post">
                            {{csrf_field()}}
                            ...
                            <div class="form-group">
                                <div class="form-row">
                                    ...
                                    <div class="col-lg-2">
                                        ...
                                        <input type="text" name="pettyCashNo" class="form-control" value="{{ $pettyCash[0]->module_code}}{{ $pettyCash[0]->dno_personal_code}}" disabled="disabled"/>
                                    </div>
                                    <div class="col-lg-2">
                                        <label>Date</label>
                     ...
                     <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <div class="form-group">
	                            ...
	                            @endif
                                <form action ="{{ action('DnoPersonalController@addNewPettyCash', $pettyCash[0]->id) }}" method="post">
                                {{csrf_field()}}
                                <div class="form-row">
                                     <div class="col-lg-12">
                                        <label>Date</label>
