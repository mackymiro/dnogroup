			...
			<div class="container-fluid">
				 <!-- Breadcrumbs-->
		            <ol class="breadcrumb">
		             ...
		             <a href="{{ url('ribos-bar/payment-voucher-form') }}">Back to Form</a>
	              	<div class="col-lg-12">
		            		...
		            		<div class="card mb-3">
		            			<div class="card-header">
	                              <i class="fas fa-file-invoice" aria-hidden="true"></i>
	                          	 ...
	                          	 <form action="{{ action('RibosBarController@updatePaymentVoucher', $getPaymentVoucher['id']) }}" method="post">
	                          	 	 {{ csrf_field() }}
                          	 			...
                          	 			<div class="form-row">
                  	 						<div class="col-lg-4">
	              	  						...
	              	  						<div class="col-lg-4">
                  	  							...
                  	  							<input type="text" name="accountNumber" class="form-control" value="{{ $getPaymentVoucher['account_no']}}" />
                  	  						</div>
                  	  						<div class="col-lg-2">
		                                      <label>Date</label>
        					...
        					<div class="card-header">
	                      	...
	                      	<div class="card-body">
                                 ...
                                 <input name="_method" type="hidden" value="PATCH">
	                      		...
	                      		<div>
		                        @if($user->role_type == 1)
		                        	<a href="{{ url('ribos-bar/add-new-ribos-bar-payment-voucher/'.$getPaymentVoucher['id']) }}" class="btn btn-primary">Add New </a>
		                        @endif
		                      </div>
	                      	</div>
        				</div>
