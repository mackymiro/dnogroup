              ...
              <div class="row">
                 <div class="col-lg-12">
                     <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <form action="{{ action('WimpysFoodExpressController@search') }}" method="get">
                            {{ csrf_field() }}
                                ...
                                <div class="form-row">
                                     <div class="col-lg-4">
                                        ...
                                        <select data-live-search="true" name="searchCode" class="form-control selectpicker">
                                            ...
                                            <option value="{{ $getAllCode['wimpys_food_express_code']}}">{{ $getAllCode['wimpys_food_express_code']  }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                            ...
                            @if($module === "Payment Voucher")
                                @foreach($getSearchPaymentVouchers as $getSearchPaymentVoucher)
                                    ...
                                    <p style="font-size:28px;">
                                        {{ $getSearchPaymentVoucher->module_name}} <br>{{ $getSearchPaymentVoucher->module_code }}{{ $getSearchPaymentVoucher->wimpys_food_express_code }}
                                        <a href="/wimpys-food-express/{{ $getSearchPaymentVoucher->id }}/view-wimpys-food-express-payables-detail">View Number Code</a> 
                                    </p>
                                    @else
