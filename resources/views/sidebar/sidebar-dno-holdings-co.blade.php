...
<ul class="sidebar navbar-nav">
      ...
      <li class="nav-item dropdown ">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
          ...
          <a class="dropdown-item" href="{{ url('dno-holdings-co/purchase-order') }}">P.O Form</a>
        
          <a class="dropdown-item" href="{{ url('dno-holdings-co/purchase-order-lists') }}">Lists</a>
      ...
      <li class="nav-item dropdown ">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
          ...
          <a class="dropdown-item" href="{{ url('dno-holdings-co/billing-statement-form') }}">Billing Statement Form</a>
          @endif
          <a class="dropdown-item" href="{{ url('dno-holdings-co/billing-statement-lists') }}">Lists</a>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            <a class="dropdown-item" href="{{ url('dno-holdings-co/petty-cash-list') }}">Petty Cash List</a>
        </div>
      </li>
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="#" id="pagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
