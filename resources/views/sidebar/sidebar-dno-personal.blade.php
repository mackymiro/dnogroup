<!-- Sidebar  DNO Personal-->
 <ul class="sidebar navbar-nav">
      ...
      @if(Auth::user()['role_type'] != 3)
       <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            <a class="dropdown-item" href="{{ url('dno-personal/summary-report') }}">Summary Report(s)</a>
            <a class="dropdown-item" href="{{ url('dno-personal/summary-report/search-number-code') }}">Search Number Code</a>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            <a class="dropdown-item" href="{{ url('dno-personal/suppliers') }}"> Suppliers</a>
