 ...
 <ul class="sidebar navbar-nav">
      ...
      @if(Auth::user()['role_type'] != 3)
       <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            <a class="dropdown-item" href="{{ url('lolo-pinoy-grill-commissary/summary-report') }}">Summary Report(s)</a>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
          ...
          <a class="dropdown-item" href="{{ url('lolo-pinoy-grill-commissary/view-list-per-branch') }}">View List Per Branch</a>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            <a class="dropdown-item" href="{{ url('lolo-pinoy-grill-commissary/suppliers') }}"> Suppliers</a>
