...
<ul class="sidebar navbar-nav">
     ...
     <!-- <li class="nav-item dropdown">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
          <a class="dropdown-item" href="{{ url('wimpys-food-express/delivery-receipt-form') }}">Delivery Receipt Form</a>
          <a class="dropdown-item" href="{{ url('wimpys-food-express/delivery-receipt/lists') }}">Lists</a>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            <a class="dropdown-item" href="{{ url('wimpys-food-express/petty-cash-list') }}">Petty Cash List</a>
        </div>
      </li>
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="#" id="pagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
          ...
          <a class="dropdown-item" href="{{ url('wimpys-food-express/stock-inventory') }}">Stock Inventory</a>
        </div>
      </li>
 </ul>