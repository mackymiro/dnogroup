      ...
      @if(Auth::user()['role_type'] != 3)
       <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            <a class="dropdown-item" href="{{ url('ribos-bar/summary-report') }}">Summary Report(s)</a>
            <a class="dropdown-item" href="{{ url('ribos-bar/summary-report/search-number-code') }}">Search Number Code</a>
