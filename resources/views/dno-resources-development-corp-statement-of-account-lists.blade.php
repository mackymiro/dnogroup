              ...
              <div class="row">
              		<div class="col-lg-12">
                       ...
                       <div class="float-right">
                          <a href="{{ action('DnoResourcesDevelopmentController@printSOALists') }}"><i class="fa fa-print fa-2x" aria-hidden="true"></i></a>
                        </div>
                    </div>
    					  <div class="card-body">
                                      ...
                                      <tbody>
                                            ...
                                            <tr id="deletedId{{ $statementOfAccount->id}}">
                                                <td>
                                                    ...
                                                    <a href="/dno-resources-development/{{ $statementOfAccount->id }}/edit-statement-of-account" title="Edit"><i class="fas fa-pencil-alt"></i></a>
                                                    @endif
                                                    
                                                    <a href="/dno-resources-development/{{ $statementOfAccount->id }}/view-statement-account" title="View"><i class="fas fa-low-vision"></i></a>
                                                ...
                                                <td>
                                                    @foreach($statementOfAccount->statement_of_accounts as $statement)
                                                        @if($statement->module_name === "Statement Of Account")
                                                          {{ $statement->module_code }}{{ $statement->dno_resources_code }}
                                                        @endif
                                                    @endforeach
                                                </td>
