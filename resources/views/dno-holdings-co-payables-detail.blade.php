    ...
    <div id="content-wrapper">
        <div class="container-fluid">
             <!-- Breadcrumbs-->
              ...
              <a href="{{ url('dno-holdings-co/payables/transaction-list')}}">Back to Transaction Lists</a>
               <br>
               <br>
                 <div class="row">
               		...
               		<div class="col-lg-4">
       					<div class="card mb-3">
	    					 ...
	    					 <i class="fas fa-money-check"></i>
	    					  ...
	    					  <div class="card-body">
	    					  		<form action="{{ action('DnoHoldingsCoController@addPayment', $transactionList[0]->id) }}" method="post">
	    					  			{{ csrf_field() }}
						...
						<div class="card mb-3">
							...
							<div class="card-body">
  								<form action="{{ action('DnoHoldingsCoController@addParticulars', $transactionList[0]->id) }}" method="post">
								  {{ csrf_field() }}
               			...
               			<div class="card mb-3">
	    					 ...
	    					 <i class="fas fa-money-check"></i>
    					  	...
    					  	<div class="card-body">
		                         ...
		                         @endif
    					  		<form action="{{ action('DnoHoldingsCoController@accept', $transactionList[0]->id)}}" method="post">
    					  			{{ csrf_field() }}
				  				...
				  				<div class="form-group">
			  						<div class="form-row">
			  							...
			  							<div class="col-lg-4">
		  									<label>PV No</label>
		  									<input type="text" name="voucherRef" class="form-control" value="{{ $transactionList[0]->module_code}}{{ $transactionList[0]->dno_holdings_code}}" disabled="disabled" />
			  							</div>
										  <div class="col-lg-4">
...
<script type="text/javascript">
	...
	const updateDetailsPayable = (id) =>{
		...
		$.ajax({
			type:"PATCH",
            url:'/dno-holdings-co/payables/update-details/' + id,
			data:{
                _method:'patch',
                "_token":"{{ csrf_token() }}",
                "id":id,
	...
	const updateCash = (id) => {
		...
		$.ajax({
			type:"PATCH",
            url:'/dno-holdings-co/payables/update-cash/' + id,
			data:{
                _method:'patch',
                "_token":"{{ csrf_token() }}",
                "id":id,
	...
	const updateCheck = (id) => {
			...
			$.ajax({
				type:"PATCH",
				url:'/dno-holdings-co/payables/update-check/' + id,
				data:{
					_method:'patch',
					"_token":"{{ csrf_token() }}",
					"id":id,
	...
	const updateP = (id) =>{
		...
		const transId = $("#transId"+id).val();
		 ...
		 $.ajax({
			type:"PATCH",
            url:'/dno-holdings-co/payables/updateP/' + id,
			data:{
                _method:'patch',
                "_token":"{{ csrf_token() }}",
                "id":id,
	...
	const updateParticular = (id) =>{
		...
		const amount = $("#amount").val();
		 ...
		 $.ajax({
			type:"PATCH",
            url:'/dno-holdings-co/payables/update-particulars/' + id,
			data:{
                _method:'patch',
                "_token":"{{ csrf_token() }}",
                "id":id,
