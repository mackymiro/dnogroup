				  				...
				  				<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
				  					...
				  					<tbody>
                                        ...
                                        <tr id="deletedId{{ $purchaseOrder->id }}">
                                            ...
                                            <a href="{{ url('dno-food-ventures/'.$purchaseOrder->id.'/edit') }}" title="Edit"><i class="fas fa-pencil-alt"></i></a>
...
<script type="text/javascript">
    function confirmDelete(id){
        ...
        if(x){
            $.ajax({
              type: "DELETE",
              url: '/dno-food-ventures/delete/PO/' + id,
              data:{
                _method: 'delete', 
                "_token": "{{ csrf_token() }}",
                "id": id
