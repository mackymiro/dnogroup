    		  ...
    		  <div class="row">
    		  		<div class="col-lg-12">
		  				<div class="card mb-3">
                            ...
                            <form action="{{ action('RibosBarController@updateSalesInvoice', $getSalesInvoice['id'])}}" method="post">
                            	{{csrf_field()}}
		  				...
		  				<div class="card mb-3">
                            ...
                            Edit Sales Invoice</div>
                             <div class="card-body">
                             	...
                             	<form action="{{ action('RibosBarController@updateSi', $sInvoice['id']) }}" method="post">
                             	 {{csrf_field()}}
                                 <input name="_method" type="hidden" value="PATCH">
                             	<div class="form-group">
