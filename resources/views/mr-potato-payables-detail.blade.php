               		...
               		<div class="col-lg-4">
       					<div class="card mb-3">
	    					 ...
	    					 <i class="fas fa-money-check"></i>
	    					  ...
	    					  <div class="card-body">
	    					  		<form action="{{ action('MrPotatoController@addPayment', $transactionList[0]->id) }}" method="post">
	    					  			{{ csrf_field() }}
						...
						<div class="card mb-3">
							...
							<div class="card-body">
  								<form action="{{ action('MrPotatoController@addParticulars', $transactionList[0]->id) }}" method="post">
								  {{ csrf_field() }}
               			...
               			<div class="card mb-3">
	    					 ...
	    					 <i class="fas fa-money-check"></i>
    					  	...
    					  	<div class="card-body">
		                         ...
		                         @endif
    					  		<form action="{{ action('MrPotatoController@accept', $transactionList[0]->id)}}" method="post">
    					  			{{ csrf_field() }}
								...
								<table class="table table-bordered">
				  				...
				  				<div class="form-group">
			  						<div class="form-row">
			  							...
			  							<div class="col-lg-4">
		  									<label>PV No</label>
		  									<input type="text" name="voucherRef" class="form-control" value="{{ $transactionList[0]->module_code}}{{ $transactionList[0]->mr_potato_code}}" disabled="disabled" />
			  							</div>
										  <div class="col-lg-4">
...
<script type="text/javascript">
	...
	const updateDetailsPayable = (id) =>{
		...
		$.ajax({
			type:"PATCH",
            url:'/mr-potato/payables/update-details/' + id,
			data:{
                _method:'patch',
                "_token":"{{ csrf_token() }}",
                "id":id,
	...
	const updateCash = (id) => {
		...
		$.ajax({
			type:"PATCH",
            url:'/mr-potato/payables/update-cash/' + id,
			data:{
                _method:'patch',
                "_token":"{{ csrf_token() }}",
                "id":id,
	...
	const updateCheck = (id) =>{
		...
		$.ajax({
				type:"PATCH",
				url:'/mr-potato/payables/update-check/' + id,
				data:{
					_method:'patch',
					"_token":"{{ csrf_token() }}",
					"id":id,
