		...
		<div class="container-fluid">
			<!-- Breadcrumbs-->
	         <ol class="breadcrumb">
	          ...
	          <a href="{{ url('dno-food-ventures/') }}">Back to Lists</a>
	          <div class="col-lg-12">
    		  ...
    		  <div class="row">
    		  		<div class="col-lg-12">
    		  			<div class="card mb-3">
                            ...
                            <form action="{{ action('DnoFoodVenturesController@updateSalesInvoice', $getSalesInvoice['id']) }}" method="post">
                        		{{csrf_field()}}
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                             @if(session('addSalesInvoiceSuccess'))
		                      ...
		                      @endif 
					  		<form action="{{ action('DnoFoodVenturesController@addNewSalesInvoiceData', $id) }}" method="post">
					  			{{csrf_field()}}
                            <div class="form-group">
				  				<div class="form-row">
			  						<div class="col-md-12">
  				...
  				<div class="col-lg-8">
  					<div class="card mb-3">
                        ...
                        <div class="card-body">
                        	 ...
                        	 <form action="{{ action('DnoFoodVenturesController@updateSi', $sInvoice['id']) }}" method="post">
                        	 	{{csrf_field()}}
                           <input name="_method" type="hidden" value="PUT">
                        	 <div class="form-group">
