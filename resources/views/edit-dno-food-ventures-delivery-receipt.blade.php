	 ...
	 <div id="content-wrapper">
	 	<div class="container-fluid">
	         ...
	         <ol class="breadcrumb">
	          ...
	          <a href="{{ url('dno-food-ventures/delivery-receipt/lists') }}">Back to Lists</a>
	          <div class="col-lg-12">
			  ...
			  <div class="row">
                    ...
                    <br>
                      ...
                      @endif 
                    <form action="{{ action('DnoFoodVenturesController@updateDeliveryReceipt', $getDeliveryReceipt['id'])}}" method="post">
                             	{{csrf_field()}}
                            ...
                            <div class="form-row">
                     		...
                     		<div class="form-group">
                    			<div class="form-row">
                                  ...
                                  <option value="{{ $getRawMaterial->id}}-{{ $getRawMaterial->raw_material_product->product_id_no}}" <?= ($prodExp[1] == $getRawMaterial->raw_material_product->product_id_no) ? 'selected="selected"' : '' ?>>{{ $getRawMaterial->raw_material_product->product_id_no}}</option>
                                  @endforeach
                              </select>
                    				</div>
                    				<div class="col-md-1">
			  ...
			  <div class="row">
                      ...
                      <div class="card-header">
                        ...
                        <div class="card-body">
                            <form action="{{ action('DnoFoodVenturesController@addNewDeliveryReceiptData', $id)}}  " method="post">
                            {{csrf_field()}}
                            <div class="form-group">
                                <div class="form-row">
                                    <div class="col-md-12">
...
<script type="text/javascript">
     const confirmDelete = (id) => {
        ...
        if(x){
            $.ajax({
              type: "DELETE",
              url: '/dno-food-ventures/delete-delivery-receipt/' + id,
              data:{
                _method: 'delete', 
                "_token": "{{ csrf_token() }}",
                "id": id,
