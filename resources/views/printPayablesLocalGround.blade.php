...
<div id="wrapper">
	 <div id="content-wrapper">
 		<div class="container-fluid">
            	 ...
            	 <img style="margin-left: 70px;" src="{{ asset('images/digitized-logos/local-ground-pdf1.png')}}"  alt="Local Ground">
	                          ...
	                          <div style="float:right; width: 50%">
	                              <table >
	                                   <thead>
											...
											<tr>
                                                <th>PV No</th>
                                                <th>{{ $payableId[0]->module_code}}{{ $payableId[0]->local_ground_code }}</th>
                                            </tr>
											<tr>
