...
<div id="wrapper">
	 <div id="content-wrapper">
 		<div class="container-fluid">
                 ...
                 <img style="margin-left: 5px;" src="{{ asset('images/digitized-logos/wlg-corporation.png')}}"  alt="WLG Corporaton">
                            ...
                            <table style="border:1px solid black;">
                                ...
                                ?>
									...
									<tr style="border:1px solid black;">
										...
										<td style="text-align:center; border: 1px solid black;">{{ $getTransactionListCash->module_code}}{{ $getTransactionListCash->wlg_code}}</td>
                            ...
                            <table style="border:1px solid black;">
                                ...
                                ?>
									...
									<tr style="border:1px solid black;">
										...
										<td style="text-align:center; border: 1px solid black;">{{ $getTransactionListCheck->module_code}}{{ $getTransactionListCheck->wlg_code}}</td>
