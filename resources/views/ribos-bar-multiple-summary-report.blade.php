                   ...
                   <div class="col-lg-12">
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ action('RibosBarController@getSummaryReportMultiple')}}" method="get"> 
                                     {{ csrf_field() }}
                                    <div class="form-group">
                                        <div class="form-row">
                                            <div class="col-lg-4">
                                ...
                                <div class="tab-content" id="nav-tabContent">
                                    ...
                                    <div class="tab-pane fade" id="all" role="tabpanel" aria-labelledby="all-tab">
                                         ...
                                         <div class="float-right">
                                             <a href="{{ action('RibosBarController@printMultipleSummary',  $startDate.'TO'.$endDate) }}"><i class="fa fa-print fa-4x" aria-hidden="true"></i></a>
                                        </div>
