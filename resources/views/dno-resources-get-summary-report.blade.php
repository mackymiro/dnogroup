      ...
      <div id="content-wrapper">
            <div class="container-fluid">
                ...
                <ol class="breadcrumb">
                    ...
                    <a href="#">DNO Resources and Development </a>
                    </li>
                            ...
                            <div class="card-body">
                                 <div class="form-group">
                                      <div class="form-row">
                                          ...
                                          <div class="col-lg-4">
                                              <form action="{{ action('DnoResourcesDevelopmentController@getSummaryReport') }}" method="get">
                                              {{ csrf_field() }}
                                              <h1>Search Date</h1>
                                  ...
                                  <form action="{{ action('DnoResourcesDevelopmentController@getSummaryReportMultiple')}}" method="get"> 
                                     {{ csrf_field() }}
                                    <div class="form-group">
                                        <div class="form-row">
                                            <div class="col-lg-4">
                                ...
                                <div class="tab-content" id="nav-tabContent">
                                        ...
                                        <div class="table-responsive">
                                          ...
                                          <tr >
                                            ...
                                            <td>
                                              ...
                                              <p style="width:250px;">
                                              <a href="{{ url('dno-resources-development/edit-wlg-corporation-payables-detail/'.$getTransactionList->id) }}" title="Edit">{{ $getTransactionList->invoice_number}}</a>
                                              </p>
                                              @else
                                              <p style="width:250px;">{{ $getTransactionList->invoice_number}}</p>
                                              @endif
                                            </td>
                                            <td><p style="width:140px;">{{ $getTransactionList->module_code}}{{ $getTransactionList->dno_resources_code}}</p></td>
                                            ...
                                            <td class="bg-success" style="color:white; "><p style="width:240px;"><a class="anchor" href="{{ url('dno-resources-development/view-dno-resources-payables-details/'.$getTransactionList->id) }}">{{ $getTransactionList->status }}</a></p></td>
                                    ...
                                    <div class="tab-pane fade" id="all" role="tabpanel" aria-labelledby="all-tab">
                                         ...
                                         <div class="float-right">
                                             <a href="{{ action('DnoResourcesDevelopmentController@printGetSummary', $getDate) }}"><i class="fa fa-print fa-4x" aria-hidden="true"></i></a>
                                        </div>
                                        <br>
                                        <div class="table-responsive">
                                                ...
                                                @foreach($getTransactionListCashes as $getTransactionListCash)
                                                        ...
                                                        <tr >
                                                            ...
                                                            <td>
                                                                ...
                                                                <p style="width:250px;">
                                                                    <a href="{{ url('dno-resources-development/edit-wlg-corporation-payables-detail/'.$getTransactionListCash->id) }}" title="Edit">{{ $getTransactionListCash->invoice_number}}</a>
                                                                </p>
                                                                @else
                                                                <p style="width:250px;">{{ $getTransactionListCash->invoice_number}}</p>
                                                                @endif
                                                            </td>
                                                            <td><p style="width:140px;">{{ $getTransactionListCash->module_code}}{{ $getTransactionListCash->dno_resources_code}}</p></td>
                                             ...
                                             <table class="table table-bordered display" width="100%" cellspacing="0">
                                                ...
                                                @foreach($getTransactionListChecks as $getTransactionListCheck)
                                                        ...
                                                        <?php
                                                            ...
                                                            $getChecks = DB::table('dno_resources_development_corp_payment_vouchers')
                                                                        ->select('*')
                                                                        ->where('pv_id', $id)
                                                                        ->get()->toArray();
                                                        ?>
                                                        <tr >
                                                            ...
                                                            <td>
                                                                ...
                                                                <p style="width:250px;">
                                                                    <a href="{{ url('dno-resources-development/edit-dno-resources-payables-detail/'.$getTransactionListCheck->id) }}" title="Edit">{{ $getTransactionListCheck->invoice_number}}</a>
                                                                </p>
                                                                @else
                                                                <p style="width:250px;">{{ $getTransactionListCheck->invoice_number}}</p>
                                                                @endif
                                                            </td>
                                                            <td><p style="width:140px;">{{ $getTransactionListCheck->module_code}}{{ $getTransactionListCheck->dno_resources_code}}</p></td>
                                                            ...
                                                            <td class="bg-success" style="color:white; "><p style="width:240px;"><a class="anchor" href="{{ url('dno-resources-development/view-dno-resources-payables-details/'.$getTransactionListCheck->id) }}">{{ $getTransactionListCheck->status }}</a></p></td>
