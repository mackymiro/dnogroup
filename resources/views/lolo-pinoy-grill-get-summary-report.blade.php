                                 ...
                                 <div class="tab-content" id="nav-tabContent">
                                     <div class="tab-pane fade show active" id="salesInvoice" role="tabpanel" aria-labelledby="salesInvoice-tab">
                                            ...
                                            <div class="float-right">
                                                <a href="{{ action('LoloPinoyGrillCommissaryController@printGetSummarySalesInvoice', $getDate) }}"><i class="fa fa-print fa-4x" aria-hidden="true"></i></a>
                                            </div>
                                            <br>
                                            <br>
                                            <br>
                                    ...
                                    <div class="tab-pane fade" id="deliveryReceipt" role="tabpanel" aria-labelledby="deliveryReceipt-tab">
                                         <br>
                                        <div class="float-right">
                                            <a href="{{ action('LoloPinoyGrillCommissaryController@printGetSummaryDeliveryReceipt', $getDate) }}"><i class="fa fa-print fa-4x" aria-hidden="true"></i></a>
                                        </div>
                                        <br>
                                        <br>
                                        <br>
                                    ...
                                    <div class="tab-pane fade" id="purchaseOrder" role="tabpanel" aria-labelledby="purchaseOrder-tab">
                                          <br>
                                        <div class="float-right">
                                            <a href="{{ action('LoloPinoyGrillCommissaryController@printGetSummaryPurchaseOrder', $getDate) }}"><i class="fa fa-print fa-4x" aria-hidden="true"></i></a>
                                        </div>
                                        <br>
                                        <br>
                                        <br>
                                    ...
                                    <div class="tab-pane fade" id="SOA" role="tabpanel" aria-labelledby="SOA-tab">
                                          <br>
                                        <div class="float-right">
                                            <a href="{{ action('LoloPinoyGrillCommissaryController@printGetSummaryStatementOfAccount', $getDate) }}"><i class="fa fa-print fa-4x" aria-hidden="true"></i></a>
                                        </div>
                                        <br>
                                        <br>
                                        <br>
                                    ...
                                    <div class="tab-pane fade" id="billingStatement" role="tabpanel" aria-labelledby="billingStatement-tab">
                                          <br>
                                        <div class="float-right">
                                            <a href="{{ action('LoloPinoyGrillCommissaryController@printGetSummaryBillingStatement', $getDate) }}"><i class="fa fa-print fa-4x" aria-hidden="true"></i></a>
                                        </div>
                                        <br>
                                        <br>
                                        <br>
                                    ...
                                    <div class="tab-pane fade" id="all" role="tabpanel" aria-labelledby="all-tab">
                                         <br>
                                         <div class="float-right">
                                             <a href="{{ action('LoloPinoyGrillCommissaryController@printGetSummary', $getDate) }}"><i class="fa fa-print fa-4x" aria-hidden="true"></i></a>
                                        </div>
                                        <div class="form-group">
                                            <div class="form-row">
