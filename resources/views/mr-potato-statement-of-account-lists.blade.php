                  ...
                  <div class="col-lg-12">
                    ...
                    <div class="card-header">
                        ...
                        <div class="float-right">
                          <a href="{{ action('MrPotatoController@printSOALists') }}"><i class="fa fa-print fa-2x" aria-hidden="true"></i></a>
                        </div>
                    </div>
                <div class="card-body">
                            ...
                            <tr id="deletedId{{ $statementOfAccount->id}}">
                              <td>
                                 @if(Auth::user()['role_type'] !== 3)
                                  <a href="/mr-potato/{{ $statementOfAccount->id}}/edit-mr-potato-statement-of-account" title="Edit"><i class="fas fa-pencil-alt"></i></a>
                                  @endif
                                
                                  <a href="/mr-potato/{{ $statementOfAccount->id}}/view-statement-account" title="View"><i class="fas fa-low-vision"></i></a>

                              </td>
                             
                              <td>{{ $statementOfAccount->date }}</td>
                              <td>SOA-{{ $statementOfAccount->mr_potato_code}}</td>
