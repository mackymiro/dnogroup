                   ...
                   <div class="col-lg-12">
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ action('MrPotatoController@getSummaryReportMultiple')}}" method="get"> 
                                     {{ csrf_field() }}
                                    <div class="form-group">
                                        <div class="form-row">
                                            <div class="col-lg-4">
                                ...
                                <div class="tab-content" id="nav-tabContent">
                                             ...
                                             <table class="table table-bordered display" width="100%" cellspacing="0">
                                                ...
                                                @foreach($purchaseOrders as $purchaseOrder)
                                                    <tr >
                                                        ...
                                                        <td>{{ $purchaseOrder->module_code}}{{ $purchaseOrder->mr_potato_code}}</td>
                                        ...
                                        <div class="table-responsive">
                                             <table class="table table-bordered display" width="100%" cellspacing="0">
                                                ...
                                                <tr >    
                                                    ...
                                                    <td>{{ $pettyCashList->module_code}}{{ $pettyCashList->mr_potato_code }}</td>
                                                    <td><a href="{{ url('mr-potato/petty-cash/view/'.$pettyCashList->id) }}">{{ $pettyCashList->petty_cash_name}}</a></td>
                                            ...
                                            <table class="table table-bordered display" width="100%" cellspacing="0">
                                                ...
                                                <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <p style="width:250px;">
                                                                <a href="{{ url('mr-potato/edit-mr-potato-payables-detail/'.$getTransactionList->id) }}" title="Edit">{{ $getTransactionList->invoice_number}}</a>
                                                            </p>
                                                            @else
                                                            <p style="width:250px;">{{ $getTransactionList->invoice_number}}</p>
                                                            @endif
                                                        </td>
                                                        <td><p style="width:140px;">{{ $getTransactionList->module_code}}{{ $getTransactionList->mr_potato_code}}</p></td>
                                                        ...
                                                        <td class="bg-success" style="color:white; "><p style="width:240px;"><a class="anchor" href="{{ url('mr-potato/view-mr-potato-payables-details/'.$getTransactionList->id) }}">{{ $getTransactionList->status }}</a></p></td>
                                    ...
                                    <div class="tab-pane fade" id="all" role="tabpanel" aria-labelledby="all-tab">
                                        ...
                                        <div class="float-right">
                                             <a href="{{ action('MrPotatoController@printGetSummary', $getDate) }}"><i class="fa fa-print fa-4x" aria-hidden="true"></i></a>
                                        </div>
                                             ...
                                             <table class="table table-bordered display" width="100%" cellspacing="0">
                                                ...
                                                <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <p style="width:250px;">
                                                                <a href="{{ url('mr-potato/edit-mr-potato-payables-detail/'.$getTransactionListCash->id) }}" title="Edit">{{ $getTransactionListCash->invoice_number}}</a>
                                                            </p>
                                                            @else
                                                            <p style="width:250px;">{{ $getTransactionListCash->invoice_number}}</p>
                                                            @endif
                                                        </td>
                                                        <td><p style="width:140px;">{{ $getTransactionListCash->module_code}}{{ $getTransactionListCash->mr_potato_code}}</p></td>
                                            ...
                                            <table class="table table-bordered display" width="100%" cellspacing="0">
                                                ...
                                                @foreach($getTransactionListChecks as $getTransactionListCheck)
                                                    ...
                                                    <?php
                                                        ...
                                                        $getChecks = DB::table('mr_potato_payment_vouchers')
                                                                    ->select('*')
                                                                    ->where('pv_id', $id)
                                                                    ->get()->toArray();
                                                    ?>
                                                <tr>
                                                        ...
                                                        <td><p style="width:140px;">{{ $getTransactionListCheck->module_code}}{{ $getTransactionListCheck->mr_potato_code}}</p></td>
