...
@section('title', 'View Billing Statement (SSP) |')
@section('content')
      ...
      <div id="content-wrapper">
        ...
        <!-- Breadcrumbs-->
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">View Billing Statement (SSP)</li>
              </ol>
               <a href="{{ url('lolo-pinoy-lechon-de-cebu/view-per-accounts-billing-statement') }}">Back to Lists</a>
              <div class="col-lg-12">
                 <img src="{{ asset('images/lolo-pinoys-lechon-de-cebu.png')}}" width="366" height="178" class="img-responsive mx-auto d-block" alt="Lechon de Cebu">
                 
                 <h4 class="text-center"><u>VIEW BILLING STATEMENT (SSP)</u></h4>
              </div>
               <div class="row">
                <div class="col-lg-12">
                  <div class="card mb-3">
                    <div class="card-header">
                              ...
                              View Sales Invoice
                                <div class="float-right">
                                   <a href="{{ action('LoloPinoyLechonDeCebuController@printSsps', $viewSalesInvoice['id'])}}"><i class="fa fa-print fa-2x" aria-hidden="true"></i></a>
