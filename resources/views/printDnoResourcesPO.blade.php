...
<div id="wrapper">
	 <div id="content-wrapper">
 		<div class="container-fluid">
            	 ...
            	 <img style="margin-left:220px;" src="{{ asset('images/digitized-logos/dno-resources.png')}}"  width="300" height="130" alt="Dno Resources and Development Corp">
            	 	 <p >
	                              ...
	                              <table >
	                                   <thead>
                                            <tr>
                                                ...
                                                <th>{{ $purchaseOrder[0]->module_code }}{{ $purchaseOrder[0]->dno_resources_code}}</a></th>
                                            </tr>
                                            <tr>
                                                <th>Date:</th>
