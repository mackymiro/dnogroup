		  					...
		  					<div class="card-header">
		                        <i class="fas fa-receipt" aria-hidden="true"></i>
									...
									<div class="float-right">
										...
										<a href="{{ action('DnoFoodVenturesController@printDelivery', $viewDeliveryReceipt[0]->id)}}"><i class="fa fa-print fa-2x" aria-hidden="true"></i></a>
                    				 			...
                    				 			<thead>
                    				 				<tr>
                    				 					...
                    				 					<th>
															...
															@foreach($viewDeliveryReceipt[0]->delivery_receipts as $receipt)
