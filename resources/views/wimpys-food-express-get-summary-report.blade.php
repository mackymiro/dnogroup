                            ...
                            <div class="card-body">
                                ...
                                <div class="tab-content" id="nav-tabContent">
                                    ...
                                    <div class="tab-pane fade show " id="billingStatement" role="tabpanel" aria-labelledby="billingStatement-tab">
                                        ...
                                        <?php if($order === "Client Booking Form"): ?>
                                        <div class="float-right">
                                            <a href="{{ action('WimpysFoodExpressController@printSummaryGetBSCBF', $getDate) }}"><i class="fa fa-print fa-4x" aria-hidden="true"></i></a>
                                        </div>
                                        <?php elseif($order === "DR"): ?>
                                        <div class="float-right">
                                            <a href="{{ action('WimpysFoodExpressController@printSummaryGetBSDR', $getDate) }}"><i class="fa fa-print fa-4x" aria-hidden="true"></i></a>
                                        </div>
                                    ...
                                    <div class="tab-pane fade" id="all" role="tabpanel" aria-labelledby="all-tab">
                                         <br>
                                         <div class="float-right">
                                             <a href="{{ action('WimpysFoodExpressController@printGetSummary', $getDate) }}"><i class="fa fa-print fa-4x" aria-hidden="true"></i></a>
                                        </div> 
                                            ...
                                            <thead>
                                                ...
                                                @foreach($getTransactionListCashes as $getTransactionListCash)
                                                        ...
                                                        <tr >
                                                            ...
                                                            <td><p style="width:140px;">{{ $getTransactionListCash->module_code}}{{ $getTransactionListCash->wimpys_food_express}}</p></td>
