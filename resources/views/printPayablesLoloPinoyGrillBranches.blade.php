...
<div id="wrapper">
	 <div id="content-wrapper">
 		<div class="container-fluid">
				 ...
				 <img style="margin-left: 70px;" src="{{ asset('images/digitized-logos/lolo-pinoy-grill-pdf.png' )}}" alt="Lolo Pinoy Grill">
	            	 ...
	            	 <h4 ><u>PAYMENT CASH VOUCHER </u><br>Lolo Pinoy Grill Branches</h4> 
					 @else
					 <h4 ><u>PAYMENT CHECK VOUCHER </u><br>Lolo Pinoy Grill Branches</h4>
					 @endif
	            </div>
				<div class="row">
					<div class="col-lg-12">
