						 ...
						 <div class="card-body">
                                   ...
                                   <div style="float:left; width:50%">
                                    <table >
                                          <thead>
                                            ...
                                            <tr>
                                                <th>Date</th>
                                                <th> {{ $payableId['date_of_transaction'] }} </th>
                                            </tr>
                          ...
                          <table style="border:1px solid black;">
                                  ...
                                  <tbody>
                                      ...
                                      <td style="text-align:center; border: 1px solid black;">{{ $payableId['cheque_number'] }}</td>
                                    
                                      <td style="text-align:center; border: 1px solid black;"><?php echo number_format($payableId['cheque_amount'], 2); ?></td>
                                  	 	</tr>
