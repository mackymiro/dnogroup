                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            <div class="form-row">
                                                ...
                                                <div class="col-lg-4">
                                                    <form action="{{ action('DongFangCorporationController@getSummaryReport') }}" method="get">
                                                    {{ csrf_field() }}
                                                    <h1>Search Date</h1>
                             ...
                             <div class="card mb-3">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="tab-content" id="nav-tabContent">
                                            <div class="tab-pane fade show active" id="billingStatement" role="tabpanel" aria-labelledby="billingStatement-tab">
                                             <br>
                                                ...
                                                <div class="table-responsive">
                                                    ...
                                                    @foreach($getTransactionLists as $getTransactionList)
                                                        ...
                                                        <tr id="deletedId{{ $getTransactionList->id }}">
                                                            ...
                                                            <td><p style="width:140px;">{{ $getTransactionList->module_code}}{{ $getTransactionList->dong_fang_code}}</p></td>
                                            ...
                                            <div class="tab-pane fade" id="all" role="tabpanel" aria-labelledby="all-tab">
                                                ...
                                                <div class="float-right">
                                                    <a href="{{ action('DongFangCorporationController@printGetSummary', $getDate) }}"><i class="fa fa-print fa-4x" aria-hidden="true"></i></a>
                                                </div>
                                                 <br>
                                                <div class="table-responsive">
                                                      ...
                                                      <table class="table table-bordered display" width="100%" cellspacing="0">
                                                        ...
                                                        <tr >
                                                            ...
                                                            <td>
                                                                ...
                                                                <p style="width:250px;">
                                                                    <a href="{{ url('dong-fang-corporation/edit-dong-fang-payables-detail/'.$getTransactionListCash->id) }}" title="Edit">{{ $getTransactionListCash->invoice_number}}</a>
                                                                </p>
                                                                @else
                                                                <p style="width:250px;">{{ $getTransactionListCash->invoice_number}}</p>
                                                                @endif
                                                            </td>
                                                            <td><p style="width:140px;">{{ $getTransactionListCash->module_code}}{{ $getTransactionListCash->dong_fang_code}}</p></td>
                                                            ...
                                                            <td class="bg-success" style="color:white; "><p style="width:240px;"><a class="anchor" href="{{ url('dong-fang-corporation/view-dong-fang-payables-details/'.$getTransactionListCash->id) }}">{{ $getTransactionListCash->status }}</a></p></td>
                                                     ...
                                                     <table class="table table-bordered display" width="100%" cellspacing="0">
                                                        ...
                                                        <tr >
                                                            ...
                                                            <td>
                                                                ...
                                                                <p style="width:250px;">
                                                                    <a href="{{ url('dong-fang-corporation/edit-dong-fang-payables-detail/'.$getTransactionListCheck->id) }}" title="Edit">{{ $getTransactionListCheck->invoice_number}}</a>
                                                                </p>
                                                                @else
                                                                <p style="width:250px;">{{ $getTransactionListCheck->invoice_number}}</p>
                                                                @endif
                                                            </td>
                                                            <td><p style="width:140px;">{{ $getTransactionListCheck->module_code}}{{ $getTransactionListCheck->dong_fang_code}}</p></td>
                                                            ...
                                                            <td class="bg-success" style="color:white; "><p style="width:240px;"><a class="anchor" href="{{ url('dong-fang-corporation/view-dong-fang-payables-details/'.$getTransactionListCheck->id) }}">{{ $getTransactionListCheck->status }}</a></p></td>
