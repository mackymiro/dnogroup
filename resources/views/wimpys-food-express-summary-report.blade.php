                                ...
                                <div class="tab-content" id="nav-tabContent">
                                    <div class="tab-pane fade show active" id="clientBookingForm" role="tabpanel" aria-labelledby="clientBookingForm-tab">
                                        ...
                                        <div class="float-right">
                                            <a href="{{ action('WimpysFoodExpressController@printSummaryClientBooking') }}"><i class="fa fa-print fa-4x" aria-hidden="true"></i></a>
                                        </div>
                                        <br>
                                        <br>
                                        <br>
                                    ...
                                    <div class="tab-pane fade show " id="deliveryReceipt" role="tabpanel" aria-labelledby="deliveryReceipt-tab">
                                        <br>
                                        <div class="float-right">
                                            <a href="{{ action('WimpysFoodExpressController@printSummaryDeliveryReceipt') }}"><i class="fa fa-print fa-4x" aria-hidden="true"></i></a>
                                        </div>
                                        <br>
                                        <br>
                                        <br>
                                    ...
                                    <div class="tab-pane fade show " id="purchaseOrder" role="tabpanel" aria-labelledby="purchaseOrder-tab">
                                        <br>
                                            <div class="float-right">
                                                <a href="{{ action('WimpysFoodExpressController@printSummaryPO') }}"><i class="fa fa-print fa-4x" aria-hidden="true"></i></a>
                                            </div>
                                        <br>
                                        <br>
                                        <br>
                                    ...
                                    <div class="tab-pane fade show " id="SOA" role="tabpanel" aria-labelledby="SOA-tab">
                                        ...
                                        <div class="float-right">
                                            <a href="{{ action('WimpysFoodExpressController@printSummarySOA') }}"><i class="fa fa-print fa-4x" aria-hidden="true"></i></a>
                                        </div>
                                        <br>
                                        <br>
                                        <br>
                                    ...
                                    <div class="tab-pane fade" id="all" role="tabpanel" aria-labelledby="all-tab">
                                         <br>
                                         <div class="float-right">
                                             <a href="{{ action('WimpysFoodExpressController@printSummary') }}"><i class="fa fa-print fa-4x" aria-hidden="true"></i></a>
                                        </div> 
