                         ...
                         <div class="card-header">
                          ...
                          <div class="card-body">
                                 @if(session('SuccessE'))
                                    ...
                                    @endif 
                                  <form action="{{ action('DnoFoundationIncController@updateBillingInfo', $billingStatement['id']) }}" method="post">
                    ...
                    <div class="card mb-3">
                          ...
                          <div class="card-body">
                               @if(session('SuccessAdd'))
                                ...
                                <form action="{{ action('DnoFoundationIncController@addNewBilling', $billingStatement['id']) }}" method="post">
                                <div class="form-group">
                                    {{csrf_field()}}
                                    <div class="form-row">
                                        <div class="col-lg-12">
     ...
     const billingStatementId =  $("#billingStatementId").val();
      var x = confirm("Do you want to delete this?");
        if(x){
            $.ajax({
              type: "DELETE",
              url: '/dno-foundation-inc/delete-data-billing-statement/' + id,
              data:{
                _method: 'delete', 
                "_token": "{{ csrf_token() }}",
                "id": id,
