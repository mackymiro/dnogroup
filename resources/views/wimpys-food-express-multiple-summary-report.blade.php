                            ...
                            <div class="card-body">
                                 <div class="form-group">
                                    <div class="form-row">
                                        ...
                                        <div class="col-lg-4">
                                            <form action="{{ action('WimpysFoodExpressController@getSummaryReport') }}" method="get">
                                            {{ csrf_field() }}  
                                            <h1>Search Date</h1>
                                ...
                                <form action="{{ action('WimpysFoodExpressController@getSummaryReportMultiple')}}" method="get"> 
                                     {{ csrf_field() }}
                                    <div class="form-group">
                                        <div class="form-row">
                                            <div class="col-lg-4">
                                ...
                                <div class="tab-content" id="nav-tabContent">
                                    <div class="tab-pane fade show active" id="clientBookingForm" role="tabpanel" aria-labelledby="clientBookingForm-tab">
                                        ...
                                        <div class="float-right">
                                            <a href="{{ action('WimpysFoodExpressController@printMultipleSummaryGetClientBooking', $startDate.'TO'.$endDate) }}"><i class="fa fa-print fa-4x" aria-hidden="true"></i></a>
                                        </div>
                                        <br>
                                        <br>
                                        <br>
                                    ...
                                    <div class="tab-pane fade show " id="deliveryReceipt" role="tabpanel" aria-labelledby="deliveryReceipt-tab">
                                        <br>
                                        <div class="float-right">
                                            <a href="{{ action('WimpysFoodExpressController@printMultipleSummaryGetDeliveryReceipt', $startDate.'TO'.$endDate) }}"><i class="fa fa-print fa-4x" aria-hidden="true"></i></a>
                                        </div>
                                        <br>
                                        <br>
                                        <br>
                                    ...
                                    <div class="tab-pane fade show " id="purchaseOrder" role="tabpanel" aria-labelledby="purchaseOrder-tab">
                                        <br>
                                            <div class="float-right">
                                                <a href="{{ action('WimpysFoodExpressController@printMultipleSummaryGetPO', $startDate.'TO'.$endDate) }}"><i class="fa fa-print fa-4x" aria-hidden="true"></i></a>
                                            </div>
                                        <br>
                                        <br>
                                        <br>
                                    ...
                                    <div class="tab-pane fade show " id="SOA" role="tabpanel" aria-labelledby="SOA-tab">
                                        ...
                                        <br>
                                        <br>
                                        <form action="{{ action('WimpysFoodExpressController@selectOrderSOAMultiple',  $startDate.'TO'.$endDate) }}" method="get">
                                            {{csrf_field()}}
                                        <div class="col-lg-4">
                                        ...
                                        <div class="float-right">
                                            <a href="{{ action('WimpysFoodExpressController@printMultipleSummaryGetSOACBF', $startDate.'TO'.$endDate) }}"><i class="fa fa-print fa-4x" aria-hidden="true"></i></a>
                                        </div>
                                        <?php elseif($order === "DR"): ?>
                                        <div class="float-right">
                                            <a href="{{ action('WimpysFoodExpressController@printMultipleSummaryGetSOADR', $startDate.'TO'.$endDate) }}"><i class="fa fa-print fa-4x" aria-hidden="true"></i></a>
                                        </div>

                                        <?php else: ?>
                                        <div class="float-right">
                                            <a href="{{ action('WimpysFoodExpressController@printMultipleSummaryGetSOA', $startDate.'TO'.$endDate) }}"><i class="fa fa-print fa-4x" aria-hidden="true"></i></a>
                                        </div>
                                        <?php endif; ?>
                                    ...
                                    <div class="tab-pane fade show " id="billingStatement" role="tabpanel" aria-labelledby="billingStatement-tab">
                                        ...
                                        <br>
                                        <br>
                                        <form action="{{ action('WimpysFoodExpressController@selectOrderBSMultiple',  $startDate.'TO'.$endDate) }}" method="get">
                                            {{csrf_field()}}
                                        <div class="col-lg-4">
                                            <label>Select Order</label>
                                            <select name="selectOrder" class="form-control">
                                        ...
                                        <?php if($order === "Client Booking Form"): ?>
                                        <div class="float-right">
                                            <a href="{{ action('WimpysFoodExpressController@printMultipleSummaryGetBSCBF', $startDate.'TO'.$endDate) }}"><i class="fa fa-print fa-4x" aria-hidden="true"></i></a>
                                        </div>
                                        <?php elseif($order === "DR"): ?>
                                        <div class="float-right">
                                            <a href="{{ action('WimpysFoodExpressController@printMultipleSummaryGetBSDR', $startDate.'TO'.$endDate) }}"><i class="fa fa-print fa-4x" aria-hidden="true"></i></a>
                                        </div>

                                        <?php else: ?>
                                            <div class="float-right">
                                            <a href="{{ action('WimpysFoodExpressController@printMulitpleSummaryGetBS', $startDate.'TO'.$endDate) }}"><i class="fa fa-print fa-4x" aria-hidden="true"></i></a>
                                        </div>
                                        <?php endif; ?>
                                                    ...
                                                    @foreach($getTransactionLists as $getTransactionList)
                                                        ...
                                                        <tr >
                                                            ...
                                                            <td>
                                                                ...
                                                                <p style="width:250px;">
                                                                    <a href="wimpys-food-express/{{ $getTransactionList->id }}/edit-wimpys-food-express-payables-detail" title="Edit">{{ $getTransactionList->invoice_number}}</a>
                                                                </p>
                                                                @else
                                                                <p style="width:250px;">{{ $getTransactionList->invoice_number}}</p>
                                                                @endif
                                                            </td>
                                                            <td><p style="width:140px;">{{ $getTransactionList->module_code}}{{ $getTransactionList->wimpys_food_express_code}}</p></td>
                                                            ...
                                                            <td class="bg-success" style="color:white; "><p style="width:240px;"><a class="anchor" href="wimpys-food-express/{{ $getTransactionList->id }}/view-wimpys-food-express-payables-detail">{{ $getTransactionList->status }}</a></p></td>
                                    ...
                                    <div class="tab-pane fade" id="all" role="tabpanel" aria-labelledby="all-tab">
                                         <br>
                                         <div class="float-right">
                                             <a href="{{ action('WimpysFoodExpressController@printMultipleSummary', $startDate.'TO'.$endDate) }}"><i class="fa fa-print fa-4x" aria-hidden="true"></i></a>
                                        </div> 
                                                ...
                                                @foreach($getTransactionListCashes as $getTransactionListCash)
                                                        ...
                                                        <tr >
                                                            ...
                                                            <td>
                                                                ...
                                                                <p style="width:250px;">
                                                                    <a href="wimpys-food-express/{{ $getTransactionListCash->id }}/edit-wimpys-food-express-payables-detail" title="Edit">{{ $getTransactionListCash->invoice_number}}</a>
                                                                </p>
                                                                @else
                                                            ...
                                                            <td class="bg-success" style="color:white; "><p style="width:240px;"><a class="anchor" href="wimpys-food-express/{{ $getTransactionListCash->id}}/view-wimpys-food-express-payables-detail">{{ $getTransactionListCash->status }}</a></p></td>
                                                        ...
                                                        ?>
                                                         <tr >
                                                          ...
                                                          <td>
                                                              ...
                                                              <p style="width:250px;">
                                                                  <a href="wimpys-food-express/{{ $getTransactionListCheck->id}}/edit-wimpys-food-express-payables-detail" title="Edit">{{ $getTransactionListCheck->invoice_number}}</a>
                                                              </p>
                                                              @else
                                                              <p style="width:250px;">{{ $getTransactionListCheck->invoice_number}}</p>
                                                              @endif
                                                          </td>
                                                          <td><p style="width:140px;">{{ $getTransactionListCheck->module_code}}{{ $getTransactionListCheck->wimpys_food_express_code}}</p></td>
                                                          ...
                                                          <td class="bg-success" style="color:white; "><p style="width:240px;"><a class="anchor" href="wimpys-food-express/{{ $getTransactionListCheck->id}}/view-wimpys-food-express-payables-detail">{{ $getTransactionListCheck->status }}</a></p></td>
