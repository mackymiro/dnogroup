                                        ...
                                        <tbody> 
                                            @foreach($vecoDocuments as $vecoDocument)
                                                <tr id="deletedId{{ $vecoDocument['id']}}">
                                                    ...
                                                    <td><a href="{{ url('/mr-potato/utilities/view-veco/'.$vecoDocument['id']) }}">{{ $vecoDocument['account_id']}}</a></td>
                                            ...
                                            <tfoot>
                                             ...
                                             <tbody>
                                                ...
                                                <tr id="deletedId{{ $mcwdDocument['id']}}">
                                                    ...
                                                    <td><a href="{{ url('/mr-potato/utilities/view-mcwd/'.$mcwdDocument['id']) }}">{{ $mcwdDocument['account_id']}}</a></td>
                                        ...
                                        <tbody>
                                              @foreach($internetDocuments as $internetDocument)
                                                <tr id="deletedId{{ $internetDocument['id']}}">
                                                    ...
                                                    <td><a href="{{ url('/mr-potato/utilities/view-internet/'.$internetDocument['id']) }}">{{ $internetDocument['account_id']}}</a></td>
...
<script type="text/javascript">
     ...
     const saveInternet = () =>{
        ...
        if(accountIdInternet == "" || accountNameInternet == ""){
            ...
            $.ajax({
                type: "POST",
                url: '/mr-potato/utilities/add-internet',
                data:{
                    _method: 'post',
                    "_token": "{{ csrf_token() }}",
     ...
     const saveMCWD = () =>{
        ...
        if(accountIdMCWD == "" || accountNameMCWD == "" || meterNoMCWD == ""){
            ...
            $.ajax({
                type: "POST",
                url: '/mr-potato/utilities/add-bill',
                data:{
                    _method: 'post',
                    "_token": "{{ csrf_token() }}",
