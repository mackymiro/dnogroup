@extends('layouts.local-ground-app')
...
<div id="wrapper">
      @include('sidebar.sidebar-local-ground')
                            ...
                            <div class="card-body">
                                 <div class="form-group">
                                      <div class="form-row">
                                          ...
                                          <div class="col-lg-4">
                                              <form action="{{ action('LocalGroundController@getSummaryReport') }}" method="get">
                                              {{ csrf_field() }}
                                              <h1>Search Date</h1>
                                  ...
                                  <form action="{{ action('LocalGroundController@getSummaryReportMultiple')}}" method="get"> 
                                        {{ csrf_field() }}
                                        <div class="form-group">
                                            <div class="form-row">
                                                <div class="col-lg-4">
                                ...
                                <div class="tab-content" id="nav-tabContent">
                                        ...
                                        <div class="table-responsive">
                                          ...
                                          <tr >
                                            ...
                                            <td>
                                              ...
                                              <p style="width:250px;">
                                              <a href="{{ url('local-ground/edit-local-ground-payables-detail/'.$getTransactionList->id) }}" title="Edit">{{ $getTransactionList->invoice_number}}</a>
                                              </p>
                                              @else
                                              <p style="width:250px;">{{ $getTransactionList->invoice_number}}</p>
                                              @endif
                                            </td>
                                            <td><p style="width:140px;">{{ $getTransactionList->module_code}}{{ $getTransactionList->local_ground_code}}</p></td>
                                            ...
                                            <td class="bg-success" style="color:white; "><p style="width:240px;"><a class="anchor" href="{{ url('local-ground/view-local-ground-payables-details/'.$getTransactionList->id) }}">{{ $getTransactionList->status }}</a></p></td>
                                    ...
                                    <div class="tab-pane fade" id="all" role="tabpanel" aria-labelledby="all-tab">
                                         ...
                                         <div class="float-right">
                                             <a href="{{ action('LocalGroundController@printMultipleSummary', $startDate.'TO'.$endDate) }}"><i class="fa fa-print fa-4x" aria-hidden="true"></i></a>
                                        </div>
                                        <br>
                                        <div class="table-responsive">
                                                ...
                                                @foreach($getTransactionListCashes as $getTransactionListCash)
                                                        ...
                                                        <tr >
                                                            ...
                                                            <td>
                                                                ...
                                                                <p style="width:250px;">
                                                                    <a href="{{ url('local-ground/edit-local-ground-payables-detail/'.$getTransactionListCash->id) }}" title="Edit">{{ $getTransactionListCash->invoice_number}}</a>
                                                                </p>
                                                                @else
                                                                <p style="width:250px;">{{ $getTransactionListCash->invoice_number}}</p>
                                                                @endif
                                                            </td>
                                                            <td><p style="width:140px;">{{ $getTransactionListCash->module_code}}{{ $getTransactionListCash->local_ground_code}}</p></td>
                                                            ...
                                                            <td class="bg-success" style="color:white; "><p style="width:240px;"><a class="anchor" href="{{ url('local-ground/view-local-ground-payables-details/'.$getTransactionListCash->id) }}">{{ $getTransactionListCash->status }}</a></p></td>
                                                ...
                                                @foreach($getTransactionListChecks as $getTransactionListCheck)
                                                        ...
                                                        <tr >
                                                            ...
                                                            <td>
                                                                ...
                                                                <p style="width:250px;">
                                                                    <a href="{{ url('local-ground/edit-local-ground-payables-detail/'.$getTransactionListCheck->id) }}" title="Edit">{{ $getTransactionListCheck->invoice_number}}</a>
                                                                </p>
                                                                @else
                                                                <p style="width:250px;">{{ $getTransactionListCheck->invoice_number}}</p>
                                                                @endif
                                                            </td>
                                                            <td><p style="width:140px;">{{ $getTransactionListCheck->module_code}}{{ $getTransactionListCheck->local_ground_code}}</p></td>
                                                            ...
                                                            <td class="bg-success" style="color:white; "><p style="width:240px;"><a class="anchor" href="{{ url('local-ground/view-local-ground-payables-details/'.$getTransactionListCheck->id) }}">{{ $getTransactionListCheck->status }}</a></p></td>
