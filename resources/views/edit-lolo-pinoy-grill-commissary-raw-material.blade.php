        	  		...
        	  		<div class="col-lg-12">
        	  			<div class="card mb-3">
                        	...
                        	<div class="card-body">
	                                ...
	                                @endif 
                					<form action="{{ action('LoloPinoyGrillCommissaryController@updateRawMaterial', $getRawMaterial['id']) }}" method="post">
	                        	 		 {{csrf_field()}}
            	 					...
            	 					<div class="form-row">
        	 							<div class="col-md-2">
					                      ...
					                      <div class="col-md-2">
					                        ...
					                        <input type="text" name="stockAmount" class="form-control" value="{{ $getRawMaterial['stock_amount']}}" />
					                      </div>
