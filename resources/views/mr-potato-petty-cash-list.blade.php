                                        ...
                                        <tbody>
                                            ...
                                            <tr id="deletedId{{ $pettyCashList->id}}">    
                                                ...
                                                @if(Auth::user()['role_type'] != 3)
                                                    <a href="{{ url('mr-potato/edit-petty-cash/'.$pettyCashList->id) }}" title="Edit"><i class="fas fa-pencil-alt"></i></a>
                                                    @endif
            ...
            $("#validate").fadeIn().delay(3000).fadeOut();
             ...
             $.ajax({
                ...
                success:function(data){
                    ...
                    setTimeout(function(){
                        window.location = `/mr-potato/edit-petty-cash/${data}`;
                    }, 3000);
