...
<div id="wrapper">
     ...
     <div id="content-wrapper">  
        <div class="container-fluid">
            ...
            <a href="{{ url('dno-food-ventures/petty-cash-list') }}">Back to Lists</a>
            <div class="col-lg-12">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <form action="{{ action('DnoFoodVenturesController@updatePettyCash', $pettyCash[0]->id)}}" method="post">
                            {{csrf_field()}}
                                    ...
                                    <div class="col-lg-2">
                                        ...
                                        @foreach($pettyCash[0]->petty_cashes as $pc)
                                            @if($pc->module_name === "Petty Cash")
                                                 <input type="text" name="pettyCashNo" class="form-control" value="{{ $pc->module_code}}{{ $pc->dno_food_venture_code}}" disabled="disabled"/>
                     ...
                     <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <div class="form-group">
	                            ...
	                            @endif
                                <form action ="{{ action('DnoFoodVenturesController@addNewPettyCash', $pettyCash[0]->id) }}" method="post">
                                {{csrf_field()}}
                                <div class="form-row">
                                     <div class="col-lg-12">
                                        <label>Date</label>
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                             ...
                             <form action="{{ action('DnoFoodVenturesController@updatePC', $pettyCashSummary['id']) }}" method="post">
                                 {{csrf_field()}}
                                 <input name="_method" type="hidden" value="PUT">
     ...
     const confirmDelete = (id) => {
        const  x = confirm("Do you want to delete this?");
          if(x){
              $.ajax({
                type: "DELETE",
                url: '/dno-food-ventures/petty-cash/delete/' + id,
                data:{
                  _method: 'delete', 
                  "_token": "{{ csrf_token() }}",
                  "id": id
