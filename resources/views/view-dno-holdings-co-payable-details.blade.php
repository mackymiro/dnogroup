            		 	 ...
            		 	 <div class="card-header">
                            ...
                            @if($viewPaymentDetail[0]->deleted_at == NULL)
                             <div class="float-right">
                               <a href="{{ action('DnoHoldingsCoController@printPayablesDnoHoldingsCo', $viewPaymentDetail[0]->id) }}"><i class="fa fa-print fa-2x" aria-hidden="true"></i></a>
                             </div>
                            @endif
                        </div>
                                          ...
                                          <table class="table table-bordered">
                                              <thead>
                                                  ...
                                                  <tr>
                                                      ...
                                                      <th>{{ $viewPaymentDetail[0]->module_code}}{{ $viewPaymentDetail[0]->dno_holdings_code}}</th>
                                                  </tr>
                                                  <tr>
