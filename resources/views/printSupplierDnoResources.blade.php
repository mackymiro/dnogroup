...
<div id="wrapper">
	 <div id="content-wrapper">
 		<div class="container-fluid">
                 ...
                 <img style="margin-left:170px;" src="{{ asset('images/digitized-logos/dno-resources.png')}}" width="300" height="130" class="img-responsive mx-auto d-block" alt="DNO Resources and Development Corp">
