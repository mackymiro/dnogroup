                        ...
                        <div class="card mb-3">
                             <div class="card-header">
                                ...
                                <div class="float-right">
                                    <a href="{{ url('local-ground/supplier/print/'.$viewSupplier[0]->id) }}"><i class="fa fa-print fa-2x" aria-hidden="true"></i></a>
                                </div>
                             </div>
                                    ...
                                    <table class="table table-bordered" id="dataTable"  width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                           @foreach($supplierLists as $supplierList)
                                            <tr>
                                                <td><a href="/local-ground/edit-local-ground-payables-details/{{ $supplierList->id}}" target="_blank">{{ $supplierList->invoice_number }}</a></td>
