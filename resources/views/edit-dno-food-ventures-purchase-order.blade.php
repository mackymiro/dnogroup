...
<div id="wrapper">
    ...
    <div id="content-wrapper">   
    	...
    	<div class="container-fluid">
            ...
            <a href="{{ url('dno-food-ventures/purchase-order-lists') }}">Back to Lists</a>
            <div class="col-lg-12">
                         ...
                         <div class="card-body">
                              ...
                              <div class="form-group">
                                <div class="form-row">
                                  ...
                                  <div class="col-lg-6">
                                    <label>P.O #</label>
                                    <input type="text" name="poNum" class="form-control" disabled="disabled"  value="{{ $purchaseOrder[0]->dno_food_venture_code }}" />
                                    <label>Date</label>
                ...
                <div class="col-lg-4">
                    <div class="card mb-3">
                         <div class="card-header">
                          ...
                          <div class="card-body">
        					   		<form action="{{ action('DnoFoodVenturesController@addNewPurchaseOrder', $id) }}" method="post">
    					   				{{csrf_field()}}
                     ...
                     <div class="card mb-3">
                       ...
                       <i class="fab fa-first-order" aria-hidden="true"></i>
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ action('DnoFoodVenturesController@updatePo', $pOrder['id']) }}" method="post">
                            <div class="form-group">
                                 {{csrf_field()}}
                                 <input name="_method" type="hidden" value="PUT">
    ...
    const confirmDelete = (id) => {
        ...
        const poId = $("#poId").val();
          if(x){
              $.ajax({
                type: "DELETE",
                url: '/dno-food-ventures/delete/' + id,
                data:{
                  _method: 'delete', 
                  "_token": "{{ csrf_token() }}",
                  "id": id,
