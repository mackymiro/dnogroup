     ...
     <div id="content-wrapper">
 		 <div class="container-fluid">
            ...
            <ol class="breadcrumb">
             ...
             <div class="col-lg-12">
                <img src="{{ asset('images/digitized-logos/local-ground.png')}}" width="235" height="114" class="img-responsive mx-auto d-block" alt="Local Ground">
            		 ...
            		 <div class="card mb-3">
                            ...
                            @if($viewPaymentDetail[0]->deleted_at == NULL)
                              ...
                              <div class="float-right">
                               <a href="{{ action('LocalGroundController@printPayables', $viewPaymentDetail[0]->id) }}"><i class="fa fa-print fa-2x" aria-hidden="true"></i></a>
                             </div>
                             @endif
                          </div>
                                          ...
                                          <table class="table table-bordered">
                                              <thead>
                                                  ...
                                                  <tr>
                                                      ...
                                                      <th>{{ $viewPaymentDetail[0]->local_ground_code}}</th>
                                                  </tr>
                                                  <tr>
