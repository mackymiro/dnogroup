                                ...
                                <div>
                                 ...
                                 <div class="tab-content" id="nav-tabContent">
                                    ...
                                    <div class="tab-pane fade" id="purchaseOrder" role="tabpanel" aria-labelledby="purchaseOrder-tab">
                                        ...
                                        <div class="float-right">
                                            <a href="{{ action('LoloPinoyGrillCommissaryController@printMultipleSummaryPurchaseOrder', $startDate.'TO'.$endDate) }}"><i class="fa fa-print fa-4x" aria-hidden="true"></i></a>
                                        </div>
                                        <br>
                                        <br>
                                        <br>
                                    ...
                                    <div class="tab-pane fade" id="SOA" role="tabpanel" aria-labelledby="SOA-tab">
                                        ...
                                        <div class="float-right">
                                            <a href="{{ action('LoloPinoyGrillCommissaryController@printMultipleSummaryStatementOfAccount', $startDate.'TO'.$endDate) }}"><i class="fa fa-print fa-4x" aria-hidden="true"></i></a>
                                        </div>
                                        <br>
                                        <br>
                                        <br>
