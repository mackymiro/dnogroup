                            ...
                            <form action="{{ action('LoloPinoyGrillBranchesController@getStockInventoryDate') }}" method="get">
                               ...
                               <div class="form-group">
                                ...
                                <div class="float-right">
                                    <a href="{{ action('LoloPinoyGrillBranchesController@printGetMultipleStockInventory', $startDate.'&'.$endDate.'&'.$flag)}}" ><i class="fa fa-print fa-4x" aria-hidden="true"></i></a>
                                </div>
                                <br>
                                <br>
                                <br>
                                @if($data)
                               <h1> Search Date: {{ $startDate }} TO {{ $endDate }}</h1>
