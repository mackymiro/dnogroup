...
<div id="wrapper">
     ...
     <div id="content-wrapper">  
        <div class="container-fluid">
            ...
            <a href="{{ url('dong-fang-corporation/petty-cash-list') }}">Back to Lists</a>
            <div class="col-lg-12">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <form action="{{ action('DongFangCorporationController@updatePettyCash', $pettyCash[0]->id)}}" method="post">
                            {{csrf_field()}}
                            ...
                            <div class="form-group">
                                <div class="form-row">
                                    ...
                                    <div class="col-lg-2">
                                        ...
                                        <input type="text" name="pettyCashNo" class="form-control" value="{{ $pettyCash[0]->module_code}}{{ $pettyCash[0]->dong_fang_code}}" disabled="disabled"/>
                                    </div>
                                    <div class="col-lg-2">
                                        <label>Date</label>
                     ...
                     <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <div class="form-group">
	                            ...
	                            @endif
                                <form action ="{{ action('DongFangCorporationController@addNewPettyCash', $pettyCash[0]->id) }}" method="post">
                                {{csrf_field()}}
                                <div class="form-row">
                                     <div class="col-lg-12">
                                        <label>Date</label>
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                             ...
                             <form action="{{ action('DongFangCorporationController@updatePC', $pettyCashSummary['id']) }}" method="post">
                                 {{csrf_field()}}
                                 <input name="_method" type="hidden" value="PATCH">
