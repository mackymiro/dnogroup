...
<div id="wrapper">
	 <div id="content-wrapper">
 		<div class="container-fluid">
                 ...
                 <img style="margin-left: 250px;" src="{{ asset('images/dong-fang-corporation.png')}}"  alt="Dong Fang Corporation">
            	 	 <p >
                             ...
                             <table style="border:1px solid black;">
                                <thead>
									<tr>
										...
										<th style="height: 1%; text-align: center;">ACCOUNT NO</th>
                                        <th style="height: 1%; text-align: center;">COMPANY NAME</th>
                            ...
                            <table style="border:1px solid black;">
                                ...
                                ?>
									...
									<tr style="border:1px solid black;">
										...
										<td style="text-align:center; border: 1px solid black;">{{ $getTransactionListCash->module_code}}{{ $getTransactionListCash->dong_fang_code}}</td>
