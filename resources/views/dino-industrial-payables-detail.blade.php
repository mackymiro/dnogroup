            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <form action="{{ action('DinoIndustrialCorporationController@addPayment', $transactionList['id']) }}" method="post">
                             {{ csrf_field() }}
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <form action="{{ action('DinoIndustrialCorporationController@addParticulars', $transactionList['id']) }}" method="post">
                            {{ csrf_field() }}
                ...
                <div class="col-lg-8">
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form action="{{ action('DinoIndustrialCorporationController@accept', $transactionList['id']) }}" method="post">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                <div class="form-row">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <input type="text" name="voucherRef" class="form-control" value="DIC-{{ $transactionList['voucher_ref_number'] }}" disabled="disabled" />
                                    </div>
                                    <div class="col-lg-4">
                                        <label>Status</label>
                                        <div id="app-status">
