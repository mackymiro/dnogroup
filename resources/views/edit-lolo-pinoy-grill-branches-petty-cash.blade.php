            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <form action="{{ action('LoloPinoyGrillBranchesController@updatePettyCash', $pettyCash['id'])}}" method="post">
                            {{csrf_field()}}
                            ...
                            <div class="form-group">
                                <div class="form-row">
                                    ...
                                    <div class="col-lg-2">
                                        ...
                                        <input type="text" name="pettyCashNo" class="form-control" value="Ptylpgb-{{ $pettyCash['petty_cash_no']}}" disabled="disabled"/>
                                    </div>
                                    <div class="col-lg-2">
                                        <label>Date</label>
                     ...
                     <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <div class="form-group">
	                            ...
	                            @endif
                                <form action ="{{ action('LoloPinoyGrillBranchesController@addNewPettyCash', $pettyCash['id']) }}" method="post">
                                {{csrf_field()}}
                                <div class="form-row">
                                     <div class="col-lg-12">
                                        <label>Date</label>
