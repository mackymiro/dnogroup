					...
					<div class="col-lg-12">
						 <div class="card-body">
						  ...
						  <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        <th width="15%"  style="text-align:center; border: 1px solid black;">TOTAL PRODUCT COST:</th>
                                        <th  style="text-align:center; border: 1px solid black;"><?php echo number_format($countTotalAmount, 2);?></th>
                                    </tr>
                                </thead>
