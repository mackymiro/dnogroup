...
<div id="wrapper">
	 <div id="content-wrapper">
 		<div class="container-fluid">
                 ...
                 <img style="margin-left:170px;" src="{{ asset('images/digitized-logos/ribos-food-corp.png')}}" width="390" height="250" class="img-responsive mx-auto d-block" alt="Rib's Bar">
