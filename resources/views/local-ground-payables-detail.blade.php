...
<div id="wrapper">
   ...
   <div id="content-wrapper" >
         <div class="container-fluid">
            ...
            <a href="{{ url('local-ground/payables/transaction-list')}}">Back to Transaction Lists</a>
            <br>
            <br>
            <div class="row">
                <div class="col-lg-4">
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <form action="{{ action('LocalGroundController@addPayment', $transactionList[0]->id) }}" method="post">
                                    {{ csrf_field() }}
                    ...
                    <div class="card mb-3">
							...
							<div class="card-body">
  								<form action="{{ action('LocalGroundController@addParticulars', $transactionList[0]->id) }}" method="post">
								  {{ csrf_field() }}
                ...
                <div class="col-lg-8">
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form action="{{ action('LocalGroundController@accept', $transactionList[0]->id) }}" method="post">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                <div class="form-row">
                                    ...
                                    <div class="col-lg-4">
                                        <label>Pv No</label>
                                        <input type="text" name="voucherRef" class="form-control" value="{{ $transactionList[0]->module_code}}{{ $transactionList[0]->local_ground_code}}" disabled="disabled" />
                                    </div>
                                    <div class="col-lg-4">
...
const updateDetailsPayable = (id) =>{
		...
		$.ajax({
			type:"PATCH",
            url:'/local-ground/payables/update-details/' + id,
			data:{
                _method:'patch',
                "_token":"{{ csrf_token() }}",
                "id":id,
	...
	const updateCash = (id) => {
		...
		$.ajax({
			type:"PATCH",
            url:'/local-ground/payables/update-cash/' + id,
			data:{
                _method:'patch',
                "_token":"{{ csrf_token() }}",
                "id":id,
     ...
     const updateCheck = (id) =>{
		...
		$.ajax({
				type:"PATCH",
				url:'/local-ground/payables/update-check/' + id,
				data:{
					_method:'patch',
					"_token":"{{ csrf_token() }}",
					"id":id,
    ...
    const updateP = (id) =>{
		...
		$.ajax({
			type:"PATCH",
            url:'/local-ground/payables/updateP/' + id,
			data:{
                _method:'patch',
                "_token":"{{ csrf_token() }}",
                "id":id,
    ...
    const updateParticular = (id) =>{
		...
		const amount = $("#amount").val();
		 ...
		 $.ajax({
			type:"PATCH",
            url:'/local-ground/payables/update-particulars/' + id,
			data:{
                _method:'patch',
                "_token":"{{ csrf_token() }}",
                "id":id,
