...
<div id="wrapper">
     ...
     <div id="content-wrapper">
                                 ...
                                 <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                          @foreach($suppliers as $supplier)
                                            <tr>
                                                <td><a href="{{ url('lolo-pinoy-grill-branches/suppliers/view/'.$supplier['id']) }}">{{ $supplier['supplier_name']}}</a></td>
                                                <td>{{ $supplier['date']}}</td>
      ...
      <!-- Modal -->
    <div class="modal fade" id="addSupplier" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" data-keyboard="false" data-backdrop="static">
...
<script type="text/javascript">
     ...
     const saveSupplier = () =>{
        ...
        if(date.length === 0 || supplierName.length === 0){
            ...
            $.ajax({
                type:"POST",
                url:'/lolo-pinoy-grill-branches/supplier/add',
                data:{
                    _method:'post',
                    "_token":"{{ csrf_token() }}",
                    "date":date,
