                        ...
                        <div class="card-header">
                            ...
                            @if($purchaseOrder[0]->deleted_at == NULL)
                             <div class="float-right">
                                <a href="{{ action('DnoFoodVenturesController@printPO', $purchaseOrder[0]->id)}}"><i class="fa fa-print fa-2x" aria-hidden="true"></i></a>
                                    ...
                                    <table class="table table-bordered">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>{{ $purchaseOrder[0]->dno_food_venture_code}}</th>
                                            </tr>
                                            <tr>
                                                <th>Date</th>
