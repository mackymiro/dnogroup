	    					   			...
	    					   			<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
					  						...
					  						<tbody>
					  							...
					  							<tr id="deletedId{{ $getAllCashVoucher['id']}}">
					  								<td>
					  									<a href="{{ url('mr-potato/edit-mr-potato-payment-voucher/'.$getAllCashVoucher['id']) }}" title="Edit"><i class="fas fa-pencil-alt"></i></a>
	      		  										<a id="delete" href="javascript:void" onClick="confirmDelete('{{ $getAllCashVoucher['id']}}')" title="Delete"><i class="fas fa-trash"></i></a>
	      		  										<a href="{{ url('mr-potato/view-mr-potato-payment-voucher/'.$getAllCashVoucher['id']) }}" title="View"><i class="fas fa-low-vision"></i></a>
					  								</td>
