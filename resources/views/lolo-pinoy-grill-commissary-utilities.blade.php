                            ...
                            <table class="table table-bordered display"  width="100%" cellspacing="0">
                                ...
                                <tbody> 
                                    ...
                                    <tr id="deletedId{{ $vecoDocument['id']}}">
                                        ...
                                        <td><a href="{{ url('/lolo-pinoy-grill-commissary/utilities/view-veco/'.$vecoDocument['id']) }}">{{ $vecoDocument['account_id']}}</a></td>
                                ...
                                <table class="table table-bordered display"  width="100%" cellspacing="0">
                                        ...
                                        <tbody> 
                                            ...
                                            <tr id="deletedId{{ $mcwdDocument['id']}}">
                                                ...
                                                <td><a href="{{ url('/lolo-pinoy-grill-commissary/utilities/view-mcwd/'.$mcwdDocument['id']) }}">{{ $mcwdDocument['account_id']}}</a></td>
...
<script type="text/javascript">
    ...
    const saveInternet = () =>{
        ...
        if(accountIdInternet == "" || accountNameInternet == ""){
            ...
            $.ajax({
                type: "POST",
                url: '/lolo-pinoy-grill-commissary/utilities/add-internet',
                data:{
                    _method: 'post',
                    "_token": "{{ csrf_token() }}",
    ...
    const saveMCWD = () =>{
        ...
        if(accountIdMCWD == "" || accountNameMCWD == "" || meterNoMCWD == ""){
            ...
            $.ajax({
                type: "POST",
                url: '/lolo-pinoy-grill-commissary/utilities/add-bill',
                data:{
                    _method: 'post',
                    "_token": "{{ csrf_token() }}",
