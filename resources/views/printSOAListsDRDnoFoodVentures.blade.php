	 ...
	 <div id="content-wrapper">
 		<div class="container-fluid">
            	 ...
            	 <img style="margin-left: 5px;" src="{{ asset('images/digitized-logos/dno-food-venture-pdf.png')}}"   alt="DNO Food Ventures">
	            	 ...
	            	 <h4 ><u>STATEMENT OF ACCOUNT</u><br>Delivery Receipt</h4>
	            </div>
				<div class="row">
					<div class="col-lg-12">
						 <div class="card-body">
                          ...
                          <table style="margin-top:30px;border:1px solid black;">
                                  ...
                                  <tbody>
                                  	 	 ...
                                  	 	 @foreach($printSOAStatementsDRs as $printSOAStatement)
