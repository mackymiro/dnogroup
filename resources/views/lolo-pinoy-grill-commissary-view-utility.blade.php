      ...
      <div id="content-wrapper">
        <div class="container-fluid">
              ...
              <ol class="breadcrumb">
                ...
                @if(\Request::is('lolo-pinoy-grill-commissary/utilities/view-veco/'.$viewBill['id']))
                    <li class="breadcrumb-item active">Utilities</li>    
                    <li class="breadcrumb-item active">Veco </li>  
                    <li class="breadcrumb-item ">View Veco Details </li>  
                @elseif(\Request::is('lolo-pinoy-grill-commissary/utilities/view-mcwd/'.$viewBill['id']))
                    <li class="breadcrumb-item active">Utilities</li>    
                    <li class="breadcrumb-item active">MCWD </li>  
                    <li class="breadcrumb-item ">View MCWD Details </li> 
                @elseif(\Request::is('lolo-pinoy-grill-commissary/utilities/view-internet/'.$viewBill['id']))
                    <li class="breadcrumb-item active">Utilities</li>    
