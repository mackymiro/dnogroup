                                    ...
                                    <div class="col-lg-2">
                                        ...
                                        @foreach($pettyCash[0]->petty_cashes as $pc)
                                            @if($pc->module_name === "Petty Cash")
                                                 <input type="text" name="pettyCashNo" class="form-control" value="{{ $pc->module_code}}{{ $pc->dno_foundation_code}}" disabled="disabled"/>
                     ...
                     <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <div class="form-group">
	                            ...
	                            @endif
                                <form action ="{{ action('DnoFoundationIncController@addNewPettyCash', $pettyCash[0]->id) }}" method="post">
                                {{csrf_field()}}
                                <div class="form-row">
                                     <div class="col-lg-12">
                                        <label>Date</label>
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                             ...
                             <form action="{{ action('DnoFoundationIncController@updatePC', $pettyCashSummary['id']) }}" method="post">
                                 {{csrf_field()}}
                                 <input name="_method" type="hidden" value="PUT">
