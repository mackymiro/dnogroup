            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <form action="{{ action('DnoFoundationIncController@updatePettyCash', $pettyCash[0]->id)}}" method="post">
                            {{csrf_field()}}
                            ...
                            <div class="form-group">
                                <div class="form-row">
                                    ...
                                    <div class="col-lg-2">
                                        ...
                                        @foreach($pettyCash[0]->petty_cashes as $pc)
                                            @if($pc->module_name === "Petty Cash")
                                                 <input type="text" name="pettyCashNo" class="form-control" value="{{ $pc->module_code}}{{ $pc->wimpys_food_express_code}}" disabled="disabled"/>
                     ...
                     <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <div class="form-group">
	                            ...
	                            @endif
                                <form action ="{{ action('WimpysFoodExpressController@addNewPettyCash', $pettyCash[0]->id) }}" method="post">
                                {{csrf_field()}}
                                <div class="form-row">
                                     <div class="col-lg-12">
                                        <label>Date</label>
                                    ...
                                    <div class="col-lg-12">
                                        <label>Petty Cash Summary</label>
                                        <input type="text" name="pettyCashSummary" class="form-control" required/>
                                    </div>
                                    <div class="col-lg-12">
                                        <label>Amount</label>
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                             ...
                             <form action="{{ action('WimpysFoodExpressController@updatePC', $pettyCashSummary['id']) }}" method="post">
                                 {{csrf_field()}}
                                 <input name="_method" type="hidden" value="PUT">
     ...
     const confirmDelete = (id) => {
        const  x = confirm("Do you want to delete this?");
          if(x){
              $.ajax({
                type: "DELETE",
                url: '/wimpys-food-express/petty-cash/delete/' + id,
                data:{
                  _method: 'delete', 
                  "_token": "{{ csrf_token() }}",
                  "id": id
