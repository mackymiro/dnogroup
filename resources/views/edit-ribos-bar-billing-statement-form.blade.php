                    ...
                    <div class="card mb-3">
                          ...
                          <div class="card-body">
                               @if(session('SuccessEdit'))
                                ...
                                <form action="{{ action('RibosBarController@updateBillingStatement', $bStatement['id']) }}" method="post">
                                <div class="form-group">
                                    {{csrf_field()}}
                                    <input name="_method" type="hidden" value="PATCH">
                                ...
                                @endforeach
                                 <div>
                                  ...
                                  <a href="{{ url('ribos-bar/add-new-ribos-bar-billing/'.$billingStatement['id'] ) }}" class="btn btn-primary">Add New</a>
                                  @endif
                                </div>
                          </div>
                    </div>  
