			...
			<div class="modal-body">
				<div class="form-group">
					<div class="form-row">
						...
						<div class="col-lg-4">
							<label>Invoice No</label>
							<input type="text" id="invoiceN<?= $getParticular['id']?>" name="invoiceN" class="datepicker form-control"  value="{{ $getParticular['invoice_number']}}" />
						</div>
						<div class="col-lg-4">
							<label>Particulars</label>
...
<script type="text/javascript">
	...
	const updateDetailsPayable = (id) =>{
		...
		$.ajax({
			type:"PATCH",
            url:'/dno-food-ventures/payables/update-details/' + id,
			data:{
                _method:'patch',
                "_token":"{{ csrf_token() }}",
                "id":id,
	...
	const updateCash = (id) => {
		...
		$.ajax({
			type:"PATCH",
            url:'/dno-food-ventures/payables/update-cash/' + id,
			data:{
                _method:'patch',
                "_token":"{{ csrf_token() }}",
                "id":id,
	...
	const updateCheck = (id) =>{
		...
		$.ajax({
				type:"PATCH",
				url:'/dno-food-ventures/payables/update-check/' + id,
				data:{
					_method:'patch',
					"_token":"{{ csrf_token() }}",
					"id":id,
	...
	const updateP = (id) =>{
		...
		$.ajax({
			type:"PUT",
            url:'/dno-food-ventures/payables/updateP/' + id,
			data:{
                _method:'put',
                "_token":"{{ csrf_token() }}",
                "id":id,
	...
	const updateParticular = (id) =>{
		...
		const amount = $("#amount").val();
		 ...
		 $.ajax({
			type:"PUT",
            url:'/dno-food-ventures/payables/update-particulars/' + id,
			data:{
                _method:'put',
                "_token":"{{ csrf_token() }}",
                "id":id,
