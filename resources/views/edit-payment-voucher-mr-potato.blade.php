			...
			<div class="container-fluid">
				 <!-- Breadcrumbs-->
		            <ol class="breadcrumb">
		             ...
		             <a href="{{ url('mr-potato/payment-voucher-form') }}">Back to Form</a>
	              	<div class="col-lg-12">
		            		...
		            		<div class="card mb-3">
		            			<div class="card-header">
	                              <i class="fas fa-file-invoice" aria-hidden="true"></i>
	                          	 ...
	                          	 <form action="{{ action('MrPotatoController@updatePaymentVoucher', $getPaymentVoucher['id']) }}" method="post">
	                          	 	 {{ csrf_field() }}
        					...
        					<div class="card-header">
	                      	...
	                      	<div class="card-body">
                                 ...
                                 <input name="_method" type="hidden" value="PATCH">
	                      		...
	                      		<div>
		                        @if($user->role_type == 1)
		                        	<a href="{{ url('mr-potato/add-new-mr-potato-payment-voucher/'.$getPaymentVoucher['id']) }}" class="btn btn-primary">Add New </a>
		                        @endif
		                      </div>
	                      	</div>
        				</div>
