                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                            ...
                            <div class="float-right">
                               <a href="{{ action('DongFangCorporationController@printPettyCash', $getPettyCash[0]->id)}}"><i class="fa fa-print fa-2x" aria-hidden="true"></i></a>
                             </div>
                            @endif
                        </div>
                        <div class="card-body">
                                     ...
                                     <div class="col-lg-6">
                                         ...
                                         <thead>
                                            <tr>
                                                ...
                                                <th>{{ $getPettyCash[0]->dong_fang_code }}</th>
                                            </tr>
                                            <tr>
                                                <th>Date</th>
