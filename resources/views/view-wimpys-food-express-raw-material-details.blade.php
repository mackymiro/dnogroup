...
<div id="wrapper">
    ...
    <div id="content-wrapper">
        <div class="container-fluid">
            ...
            <a href="{{ url('wimpys-food-express/raw-materials') }}">Back to Lists</a>
            <div class="col-lg-12">
...
<script>
    ...
    const saveRequest = (id) =>{
        ...
        if(referenceNum1.length === 0 || qty1 === 0){
            ...
            $.ajax({
                type:"POST",
                url:'/wimpys-food-express/add-delivery-in-raw-material/' +id,
                data:{
                _method:'post',
                "_token":"{{ csrf_token() }}",
                "id":id,
                ...
                success:function(data){
                    ...
                    if(succDataArr == "Success"){
                      ...
                      setTimeout(function(){
                        location.reload('/wimpys-food-express/'+ id +'/view-raw-material-details/');
                      }, 3000);
                    }
