...
<div id="wrapper">
    ...
    <div id="content-wrapper" >
        <div class="container-fluid">
            ...
            <a href="{{ url('dong-fang-corporation/payables/transaction-list')}}">Back to Transaction Lists</a>
            <br>
            <br>
            <div class="row">
                <div class="col-lg-4">
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <form action="{{ action('DongFangCorporationController@addPayment', $transactionList[0]->id) }}" method="post">
                            {{ csrf_field() }}
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                           <form action="{{ action('DongFangCorporationController@addParticulars', $transactionList[0]->id) }}" method="post">
                            {{ csrf_field() }}
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            @if(session('payablesSuccess'))
                                ...
                                @endif
                             <form action="{{ action('DongFangCorporationController@accept', $transactionList[0]->id) }}" method="post">
                             	{{ csrf_field() }}
                            ...
                            <div class="form-group">
                                <div class="form-row">
                                    ...
                                    <div class="col-lg-4">
                                        <label>Pv No</label>
                                        <input type="text" name="voucherRef" class="form-control" value="{{ $transactionList[0]->module_code}}{{ $transactionList[0]->dong_fang_code}}" disabled="disabled" />
                                    </div>
                                    <div class="col-lg-4">
...
<script type="text/javascript">
    ...
    const updateDetailsPayable = (id) =>{
		...
		$.ajax({
			type:"PATCH",
            url:'/dong-fang-corporation/payables/update-details/' + id,
			data:{
                _method:'patch',
                "_token":"{{ csrf_token() }}",
                "id":id,
	...
	const updateCash = (id) => {
		...
		$.ajax({
			type:"PATCH",
            url:'/dong-fang-corporation/payables/update-cash/' + id,
			data:{
                _method:'patch',
                "_token":"{{ csrf_token() }}",
                "id":id,
    ...
    const updateCheck = (id) =>{
		...
		$.ajax({
				type:"PATCH",
				url:'/dong-fang-corporation/payables/update-check/' + id,
				data:{
					_method:'patch',
					"_token":"{{ csrf_token() }}",
					"id":id,
    ...
    const updateP = (id) =>{
		...
		$.ajax({
			type:"PATCH",
            url:'/dong-fang-corporation/payables/updateP/' + id,
			data:{
                _method:'patch',
                "_token":"{{ csrf_token() }}",
                "id":id,
    ...
    const updateParticular = (id) =>{
		...
		const amount = $("#amount").val();
		 ...
		 $.ajax({
			type:"PATCH",
            url:'/dong-fang-corporation/payables/update-particulars/' + id,
			data:{
                _method:'patch',
                "_token":"{{ csrf_token() }}",
                "id":id,
