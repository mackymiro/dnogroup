            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <form action="{{ action('DongFangCorporationController@addPayment', $transactionList['id']) }}" method="post">
                            {{ csrf_field() }}
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                           <form action="{{ action('DongFangCorporationController@addParticulars', $transactionList['id']) }}" method="post">
                            {{ csrf_field() }}
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            @if(session('payablesSuccess'))
                                ...
                                @endif
                             <form action="{{ action('DongFangCorporationController@accept', $transactionList['id']) }}" method="post">
                             	{{ csrf_field() }}
