	...
	<!-- Sidebar -->
   	...
   	<div id="content-wrapper">
   		<div class="container-fluid">
            ...
            <a href="{{ url('dno-food-ventures/commissary/raw-materials') }}">Back to Lists</a>
            <div class="col-lg-12">
				...
				<div class="form-group">
					<div class="form-row">
						...
						<div class="col-lg-2">
							...
							<input type="text" name="productId" class="form-control" value="{{ $viewRawDetail[0]->raw_material_product->product_id_no }}" readonly="readonly" />	
						</div>
						<div class="col-lg-4">
