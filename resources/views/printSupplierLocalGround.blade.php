...
<div id="wrapper">
	 <div id="content-wrapper">
 		<div class="container-fluid">
                 ...
                 <img style="margin-left:230px;" src="{{ asset('images/digitized-logos/local-ground.png')}}" width="235" height="114" class="img-responsive mx-auto d-block" alt="Local Ground">
