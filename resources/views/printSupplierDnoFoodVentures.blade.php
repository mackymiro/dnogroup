...
<div id="wrapper">
	 <div id="content-wrapper">
 		<div class="container-fluid">
                 ...
                 <img style="margin-left:170px;" src="{{ asset('images/digitized-logos/dno-food-venture.png')}}" width="366" height="178" class="img-responsive mx-auto d-block" alt="DNO Food Ventures">
