      					  			...
      					  			<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
      				  					...
      				  					<tbody>
      			  							...
      			  							<tr id="deletedId{{ $statementOfAccount['id'] }}">
      		  									<td>
      		  										<a href="{{ url('ribos-bar/edit-ribos-bar-statement-of-account/'.$statementOfAccount['id']) }}" title="Edit"><i class="fas fa-pencil-alt"></i></a>
      		  										<a id="delete" href="javascript:void" onClick="confirmDelete('{{ $statementOfAccount['id'] }}')" title="Delete"><i class="fas fa-trash"></i></a>
      		  										<a href="{{ url('ribos-bar/view-ribos-bar-statement-account/'.$statementOfAccount['id']) }}" title="View"><i class="fas fa-low-vision"></i></a>
      		  									</td>
