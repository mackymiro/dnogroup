                            ...
                            <div class="card-body">
                                 <div class="form-group">
                                      <div class="form-row">
                                          ...
                                          <div class="col-lg-4">
                                              <form action="{{ action('DnoFoodVenturesController@getSummaryReport') }}" method="get">
                                              {{ csrf_field() }}
                                              <h1>Search Date</h1>
                                  ...
                                  <form action="{{ action('DnoFoodVenturesController@getSummaryReportMultiple')}}" method="get"> 
                                     {{ csrf_field() }}
                                    <div class="form-group">
                                        <div class="form-row">
                                            <div class="col-lg-4">
                                ...
                                <div class="tab-content" id="nav-tabContent">
                                        ...
                                        <div class="table-responsive">
                                          ...
                                          <tr >
                                            ...
                                            <td>
                                              ...
                                              <p style="width:250px;">
                                              <a href="{{ url('dno-food-ventures/edit-dno-food-ventures-payables-detail/'.$getTransactionList->id) }}" title="Edit">{{ $getTransactionList->invoice_number}}</a>
                                              </p>
                                              @else
                                              <p style="width:250px;">{{ $getTransactionList->invoice_number}}</p>
                                              @endif
                                            </td>
                                            <td><p style="width:140px;">{{ $getTransactionList->module_code}}{{ $getTransactionList->dno_food_venture_code}}</p></td>
                                    ...
                                    <div class="tab-pane fade" id="all" role="tabpanel" aria-labelledby="all-tab">
                                         ...
                                         <div class="float-right">
                                             <a href="{{ action('DnoFoodVenturesController@printMultipleSummary',  $startDate.'TO'.$endDate) }}"><i class="fa fa-print fa-4x" aria-hidden="true"></i></a>
                                        </div>
                                        <br>
                                        <div class="table-responsive">
                                            ...
                                            <table class="table table-bordered display" width="100%" cellspacing="0">
                                                ...
                                                @foreach($getTransactionListCashes as $getTransactionListCash)
                                                        ...
                                                        <?php
                                                            $amount1 = DB::table('dno_food_ventures_payment_vouchers')
                                                                        ->select('*')
                                                                        ->where('id', $id)
                                                                        ->sum('amount');
                                                            
                                                            $amount2 = DB::table('dno_food_ventures_payment_vouchers')
                                                                        ->select('*')
                                                                        ->where('pv_id', $id)
                                                                        ->sum('amount');
                                                            $compute = $amount1 + $amount2;
                                                        ...
                                                        <tr >
                                                            ...
                                                            <td><p style="width:140px;">{{ $getTransactionListCash->module_code}}{{ $getTransactionListCash->dno_food_venture_code}}</p></td>
                                             ...
                                             <table class="table table-bordered display" width="100%" cellspacing="0">
                                                ...
                                                @foreach($getTransactionListChecks as $getTransactionListCheck)
                                                        ...
                                                        <?php
                                                            ...
                                                            $getChecks = DB::table('dno_food_ventures_payment_vouchers')
                                                                            ->select('*')
                                                                            ->where('pv_id', $id)
                                                                            ->get()->toArray();
                                                        ?>
                                                        <tr >
                                                            ...
                                                            <td><p style="width:140px;">{{ $getTransactionListCheck->module_code}}{{ $getTransactionListCheck->dno_food_venture_code}}</p></td>
