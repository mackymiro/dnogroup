            	...
            	<div class="col-lg-12">
            		 <div class="card mb-3">
                            ...
                            <div class="float-right">
                               <a href="{{ action('LoloPinoyGrillBranchesController@printPayables', $viewPaymentDetail[0]->id) }}"><i class="fa fa-print fa-2x" aria-hidden="true"></i></a>
                             </div>
                            @endif
                          </div>
                                          ...
                                          <table class="table table-bordered">
                                              <thead>
                                                  ...
                                                  <tr>
                                                      ...
                                                      <th>{{ $viewPaymentDetail[0]->module_code}}{{ $viewPaymentDetail[0]->lolo_pinoy_branches_code}}</th>
                                                  </tr>
                                                  <tr>
