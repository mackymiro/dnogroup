...
class CreateWimpysFoodExpressBillingStatementsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('wimpys_food_express_billing_statements', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('wimpys_food_express_billing_statements');
    }
}
