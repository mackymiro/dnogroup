...
class CreateDnoFoundationIncPaymentVouchersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('dno_foundation_inc_payment_vouchers', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('dno_foundation_inc_payment_vouchers');
    }
}
