...
class CreateWimpysFoodExpressStatementOfAccountsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('wimpys_food_express_statement_of_accounts', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('wimpys_food_express_statement_of_accounts');
    }
}
