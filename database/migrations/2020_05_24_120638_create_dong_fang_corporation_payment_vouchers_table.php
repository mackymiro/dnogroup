...
class CreateDongFangCorporationPaymentVouchersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('dong_fang_corporation_payment_vouchers', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('dong_fang_corporation_payment_vouchers');
    }
}
