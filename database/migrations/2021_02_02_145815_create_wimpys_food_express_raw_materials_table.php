...
class CreateWimpysFoodExpressRawMaterialsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('wimpys_food_express_raw_materials', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('wimpys_food_express_raw_materials');
    }
}
