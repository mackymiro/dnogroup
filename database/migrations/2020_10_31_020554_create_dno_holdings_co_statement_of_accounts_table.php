...
class CreateDnoHoldingsCoStatementOfAccountsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('dno_holdings_co_statement_of_accounts', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('dno_holdings_co_statement_of_accounts');
    }
}
