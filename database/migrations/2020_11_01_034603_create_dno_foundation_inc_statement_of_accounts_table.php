...
class CreateDnoFoundationIncStatementOfAccountsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('dno_foundation_inc_statement_of_accounts', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('dno_foundation_inc_statement_of_accounts');
    }
}
