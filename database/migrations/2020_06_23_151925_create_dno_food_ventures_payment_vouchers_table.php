...
class CreateDnoFoodVenturesPaymentVouchersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('dno_food_ventures_payment_vouchers', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('dno_food_ventures_payment_vouchers');
    }
}
