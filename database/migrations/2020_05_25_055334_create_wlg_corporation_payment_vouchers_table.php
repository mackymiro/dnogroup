...
class CreateWlgCorporationPaymentVouchersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('wlg_corporation_payment_vouchers', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('wlg_corporation_payment_vouchers');
    }
}
