...
class CreateDnoHoldingsCoBillingStatementsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('dno_holdings_co_billing_statements', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('dno_holdings_co_billing_statements');
    }
}
